...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', 'v2.1.0-alpha.1588030886+g0b51a97'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker v2.1.0-alpha.1588030886+g0b51a97`
                """)
            else:
                raise
