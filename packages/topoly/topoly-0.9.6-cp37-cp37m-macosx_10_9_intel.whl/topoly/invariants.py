...
class GlnGraph(Graph):
    ...
    def calculate(self, chain2=None, boundary=(-1, -1), boundary2=(-1, -1), matrix=False, avgGLN=False, maxGLN=False, 
        ...
        result = {'whole chains': [], 'subchain of chain 2': [], 'subchain of chain 1': [], 'local maximum': [], 'avg': None, 'matrix': None}
        ...
        if avgGLN:
            ...
            result['avg'] = round(c_gln_average(arc1, arc2, boundary[0], boundary[1], boundary2[0], boundary2[1], avg_tries),
                         precision)
            if not result['whole chains']:
                result['whole chains'] = round(c_gln(arc1, arc2, boundary[0], boundary[1], boundary2[0], boundary2[1]), precision)
