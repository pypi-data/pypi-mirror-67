...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'dicom_upload', 'static', 'extension.js'),
        os.path.join(here, 'dicom_upload', 'static', 'index.js')
    ]
...
setup_args = {
    ...
    'data_files': [
        ('share/jupyter/nbextensions/dicom-upload', [
            'dicom_upload/static/extension.js',
