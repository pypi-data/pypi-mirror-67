...
* I am working on a generatting aarch64 SciPy wheel
* This project is where I am testing the things
* You must not use this project to grab SciPy features
* I am expecting it to go away at some point in the future
* Pip version>=19.3 supports multi-arch.
* Please visit official PyPi page: https://pypi.org/project/scipy/ to install SciPy
"""
