...
if __name__ == '__main__':
    ...
    # text = '<a href="http://www.xinhuanet.com/2020-03/30/1125790062_15855704033791n.jpg" >[Media]</a>'

    # a = is_single_media(text)
    # print(a)

    a = get_full_link('138935766_15856653409641n.jpg',
                      'http://www.xinhuanet.com/english/2020-03/31/c_138935766.htm')
    print(a)
    a = get_full_link('/138935766_15856653409641n.jpg',
                      'http://www.xinhuanet.com/english/2020-03/31/c_138935766.htm')
    print(a)
    a = get_full_link('http://www.xinhuanet.com/english/2020-03/31/138935766_15856653409641n.jpg',
                      'http://www.xinhuanet.com/english/2020-03/31/c_138935766.htm')
    print(a)
