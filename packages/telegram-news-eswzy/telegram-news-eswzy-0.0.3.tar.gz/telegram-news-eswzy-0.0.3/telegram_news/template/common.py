...
class NewsPostman(object):
    ...
    def _post(self, item, news_id):
        ...
        for chat_id in self._sendList:
            ...
            post_url = 'https://api.telegram.org/bot' + self._BOT_TOKEN + '/sendMessage?chat_id=' + chat_id + '&text=' + \
    ...
    def poll(self, sleep_time=30):
        ...
        # Boot check
        if not self._table_name or not self._BOT_TOKEN or not self._db:
...
if __name__ == '__main__':
    ...
    #     'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) '
    #                   'Chrome/80 Safari/537.36',
    #     'Cookie': 'FSSBBIl1UgzbN7N80S=roCVRVjgx8g2QHMEWN6ZSb0fGPpqJ5FMmy98Dzc4f_3VdRff6qat.iKcJF4X6OHb; '
    #               '_trs_uv=k8iilirw_2998_p6d; _trs_ua_s_1=k8iilurw_2998_3mv2; '
    #               'dataHide2=fec325e5-12ba-4b28-8eff-3ab04e9f3544; FSSBBIl1UgzbN7Nenable'
    #               'FSSBBIl1UgzbN7N80T=4Mls4zmcSGfr0Wwfa74Kw5pme35D3NdhVkIMuhpG7BuuHILZTJ63VpDuPjtOLHHBZ'
    #               'BLZXEx6eTjaRSaF6fB6JY6LCpo8MstvwRmBuOBL4hI2Q4e5lcuI.80RPSwvmiucR4RNeeSRcXZhCvpM1cVCqe'
    #               'xkktDqPcx6LY60wGpS1URCYmUuG3HM.PMl5tG85aHUfvZ5SFaEbJ2_dvcWI3g6lVrH65G.u19y6AlAXn1XtTH'
    #               'u23PckcvTByiRskVW9hwvIPM8.nWRgOY6egxs1YZgSFCAKDCYiBw70HBxks95PAtfbaSc55c7lno6lpn8YW0R'
    #               'sCzdNVPVViD4clfCG4hmMPZKAIMpbFS3wUDyuVmshCpd5xn0w1t6I172.X14Ag1IcfjnTcrr8yiv2d3P34_Pw17Hx '
    # }
    #
    # ll = NewsPostman(['http://wjw.hubei.gov.cn/bmdt/ztzl/fkxxgzbdgrfyyq/xxfb/'], sendList=[channel],
    #                  lang='鄂卫健委', headers=header)
    # lIE = InfoExtractor()
    # lIE.set_list_selector('#share > li > a')
    # lIE.set_title_selector('body > div.wrap > div.content > div > div > div.main > div.article > h2')
    # lIE.set_paragraph_selector('#article-box > div > p, #article-box > div > ul')
    # lIE.set_time_selector('body > div.wrap > div.content > div > div > div.main > div.article > '
    #                       'div.option.clearfix > div.info > span:nth-child(1)')
    # lIE.set_source_selector('body > div.wrap > div.content > div > div > div.main > div.article > '
    #                         'div.option.clearfix > div.info > span.source')
    # ll.set_extractor(lIE)
    # ll.poll()
