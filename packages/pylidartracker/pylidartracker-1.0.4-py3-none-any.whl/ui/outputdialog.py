...
class OutputDialog(QtWidgets.QDialog):
    ...
    def _connectOwnButtons(self):
        ...
        self.to_frame.valueChanged.connect(self.validate_range)
        self.from_frame.valueChanged.connect(self.validate_range)

    def validate_range(self):
        is_correct_range = (
            self.to_frame.value() > self.from_frame.value()) & (
            self.to_frame.value() <= self.max_frames)
        self.dialogButtons.setEnabled(is_correct_range)
