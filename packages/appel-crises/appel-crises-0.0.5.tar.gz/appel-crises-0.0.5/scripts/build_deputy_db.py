...
class MP:
    ...
    def __init__(self, nom, sexe, num_deptmt, nom_circo, num_circo, groupe_sigle,
                 commission_permanente, fonction, sites_web, emails, twitter, autres_mandats, tel,
                 adresse_permanence, cp_permanence, ville_permanence):
