...
# -*- coding: utf-8 -*-
#
# ipylayout documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipylayout', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipylayoutdoc'
...
latex_documents = [
    (master_doc, 'ipylayout.tex', 'ipylayout Documentation',
