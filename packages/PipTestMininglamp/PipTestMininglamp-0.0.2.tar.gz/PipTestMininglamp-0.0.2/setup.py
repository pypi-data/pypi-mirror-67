...
setuptools.setup(
    name="PipTestMininglamp",                               # 包的分发名称，使用字母、数字、_、-
    version="0.0.2",                                        # 版本号, 版本号规范：https://www.python.org/dev/peps/pep-0440/
    author="wangyijun",                                     # 作者名字
    author_email="dragonwyj@163.com",                       # 作者邮箱
    description="PipTest",                                  # 包的简介描述
    ...
    url="https://github.com/Dragonwyj/tmp",                 # 项目开源地址，我这里写的是同性交友官网，大家可以写自己真实的开源网址
