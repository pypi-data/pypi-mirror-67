...
class InvalidResponseSignatureException(CoreException):
	def __init__(A,code,message,jws,response_body):B=response_body;A.jws=jws;A.response_body=B;super().__init__(code,f"{code} {message}.\nJWS: {jws},\nBody: {B}")