...
class LuminorConnectorSettings(ConnectorSettings):
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:_B,_D:_B,_E:_B};attribute_map={_C:'clientId',_D:'clientSecret',_E:'companyName'}
	def __init__(A,client_id=_A,client_secret=_A,company_name=_A):'LuminorConnectorSettings - a model defined in Swagger';A._client_id=_A;A._client_secret=_A;A._company_name=_A;A.discriminator=_A;A.client_id=client_id;A.client_secret=client_secret;A.company_name=company_name
	@property
	def client_id(self):'Gets the client_id of this LuminorConnectorSettings.  # noqa: E501\n\n        API client ID  # noqa: E501\n\n        :return: The client_id of this LuminorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_id
	@client_id.setter
	def client_id(self,client_id):
		'Sets the client_id of this LuminorConnectorSettings.\n\n        API client ID  # noqa: E501\n\n        :param client_id: The client_id of this LuminorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_id
		if A is _A:raise ValueError('Invalid value for `client_id`, must not be `None`')
		self._client_id=A
	@property
	def client_secret(self):'Gets the client_secret of this LuminorConnectorSettings.  # noqa: E501\n\n        API client secret  # noqa: E501\n\n        :return: The client_secret of this LuminorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_secret
	@client_secret.setter
	def client_secret(self,client_secret):
		'Sets the client_secret of this LuminorConnectorSettings.\n\n        API client secret  # noqa: E501\n\n        :param client_secret: The client_secret of this LuminorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_secret
		if A is _A:raise ValueError('Invalid value for `client_secret`, must not be `None`')
		self._client_secret=A
	@property
	def company_name(self):'Gets the company_name of this LuminorConnectorSettings.  # noqa: E501\n\n        Company name displayed to the PSU during authorization  # noqa: E501\n\n        :return: The company_name of this LuminorConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._company_name
	@company_name.setter
	def company_name(self,company_name):
		'Sets the company_name of this LuminorConnectorSettings.\n\n        Company name displayed to the PSU during authorization  # noqa: E501\n\n        :param company_name: The company_name of this LuminorConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=company_name
		if A is _A:raise ValueError('Invalid value for `company_name`, must not be `None`')
		self._company_name=A
	def to_dict(D):
		...
		if issubclass(LuminorConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,LuminorConnectorSettings):return False
