...
class BIBConnectorSettings(ConnectorSettings):
	'NOTE: This class is auto generated by the swagger code generator program.\n\n    Do not edit the class manually.\n    ';'\n    Attributes:\n      swagger_types (dict): The key is attribute name\n                            and the value is attribute type.\n      attribute_map (dict): The key is attribute name\n                            and the value is json key in definition.\n    ';swagger_types={_C:_B,_D:_B,_E:_B,_F:_B,_G:_B,_H:_B};attribute_map={_C:_C,_D:'certPath',_E:'keyPath',_F:'signKeyPath',_G:'signPubKeySerial',_H:'signCertString'}
	def __init__(A,country=_A,cert_path=_A,key_path=_A,sign_key_path=_A,sign_pub_key_serial=_A,sign_cert_string=_A):'BIBConnectorSettings - a model defined in Swagger';A._country=_A;A._cert_path=_A;A._key_path=_A;A._sign_key_path=_A;A._sign_pub_key_serial=_A;A._sign_cert_string=_A;A.discriminator=_A;A.country=country;A.cert_path=cert_path;A.key_path=key_path;A.sign_key_path=sign_key_path;A.sign_pub_key_serial=sign_pub_key_serial;A.sign_cert_string=sign_cert_string
	@property
	def country(self):'Gets the country of this BIBConnectorSettings.  # noqa: E501\n\n        Bank`s country  # noqa: E501\n\n        :return: The country of this BIBConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._country
	@country.setter
	def country(self,country):
		'Sets the country of this BIBConnectorSettings.\n\n        Bank`s country  # noqa: E501\n\n        :param country: The country of this BIBConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=country
		if A is _A:raise ValueError('Invalid value for `country`, must not be `None`')
		self._country=A
	@property
	def cert_path(self):'Gets the cert_path of this BIBConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate in PEM format  # noqa: E501\n\n        :return: The cert_path of this BIBConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._cert_path
	@cert_path.setter
	def cert_path(self,cert_path):
		'Sets the cert_path of this BIBConnectorSettings.\n\n        Path to QWAC certificate in PEM format  # noqa: E501\n\n        :param cert_path: The cert_path of this BIBConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=cert_path
		if A is _A:raise ValueError('Invalid value for `cert_path`, must not be `None`')
		self._cert_path=A
	@property
	def key_path(self):'Gets the key_path of this BIBConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate private key in PEM format  # noqa: E501\n\n        :return: The key_path of this BIBConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._key_path
	@key_path.setter
	def key_path(self,key_path):
		'Sets the key_path of this BIBConnectorSettings.\n\n        Path to QWAC certificate private key in PEM format  # noqa: E501\n\n        :param key_path: The key_path of this BIBConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=key_path
		if A is _A:raise ValueError('Invalid value for `key_path`, must not be `None`')
		self._key_path=A
	@property
	def sign_key_path(self):'Gets the sign_key_path of this BIBConnectorSettings.  # noqa: E501\n\n        Path to QSeal certificate in PEM format  # noqa: E501\n\n        :return: The sign_key_path of this BIBConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_key_path
	@sign_key_path.setter
	def sign_key_path(self,sign_key_path):
		'Sets the sign_key_path of this BIBConnectorSettings.\n\n        Path to QSeal certificate in PEM format  # noqa: E501\n\n        :param sign_key_path: The sign_key_path of this BIBConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_key_path
		if A is _A:raise ValueError('Invalid value for `sign_key_path`, must not be `None`')
		self._sign_key_path=A
	@property
	def sign_pub_key_serial(self):'Gets the sign_pub_key_serial of this BIBConnectorSettings.  # noqa: E501\n\n        Public serial key of the QSeal certificate located in signKeyPath  # noqa: E501\n\n        :return: The sign_pub_key_serial of this BIBConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_pub_key_serial
	@sign_pub_key_serial.setter
	def sign_pub_key_serial(self,sign_pub_key_serial):
		'Sets the sign_pub_key_serial of this BIBConnectorSettings.\n\n        Public serial key of the QSeal certificate located in signKeyPath  # noqa: E501\n\n        :param sign_pub_key_serial: The sign_pub_key_serial of this BIBConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_pub_key_serial
		if A is _A:raise ValueError('Invalid value for `sign_pub_key_serial`, must not be `None`')
		self._sign_pub_key_serial=A
	@property
	def sign_cert_string(self):'Gets the sign_cert_string of this BIBConnectorSettings.  # noqa: E501\n\n        QSEAL public certificate string   # noqa: E501\n\n        :return: The sign_cert_string of this BIBConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._sign_cert_string
	@sign_cert_string.setter
	def sign_cert_string(self,sign_cert_string):
		'Sets the sign_cert_string of this BIBConnectorSettings.\n\n        QSEAL public certificate string   # noqa: E501\n\n        :param sign_cert_string: The sign_cert_string of this BIBConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=sign_cert_string
	...
	def to_dict(D):
		...
		if issubclass(BIBConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,BIBConnectorSettings):return False
