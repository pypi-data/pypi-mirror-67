...
class SydbankConnectorSettings(ConnectorSettings):
	...
	@property
	def client_id(self):'Gets the client_id of this SydbankConnectorSettings.  # noqa: E501\n\n        API client ID (obtained at Open Banking Market)  # noqa: E501\n\n        :return: The client_id of this SydbankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._client_id
	@client_id.setter
	def client_id(self,client_id):
		'Sets the client_id of this SydbankConnectorSettings.\n\n        API client ID (obtained at Open Banking Market)  # noqa: E501\n\n        :param client_id: The client_id of this SydbankConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=client_id
		if A is _A:raise ValueError('Invalid value for `client_id`, must not be `None`')
		self._client_id=A
	@property
	def cert_path(self):'Gets the cert_path of this SydbankConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate in PEM format.   # noqa: E501\n\n        :return: The cert_path of this SydbankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._cert_path
	@cert_path.setter
	def cert_path(self,cert_path):
		'Sets the cert_path of this SydbankConnectorSettings.\n\n        Path to QWAC certificate in PEM format.   # noqa: E501\n\n        :param cert_path: The cert_path of this SydbankConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=cert_path
		if A is _A:raise ValueError('Invalid value for `cert_path`, must not be `None`')
		self._cert_path=A
	@property
	def key_path(self):'Gets the key_path of this SydbankConnectorSettings.  # noqa: E501\n\n        Path to QWAC certificate private key in PEM format.   # noqa: E501\n\n        :return: The key_path of this SydbankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._key_path
	@key_path.setter
	def key_path(self,key_path):
		'Sets the key_path of this SydbankConnectorSettings.\n\n        Path to QWAC certificate private key in PEM format.   # noqa: E501\n\n        :param key_path: The key_path of this SydbankConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=key_path
		if A is _A:raise ValueError('Invalid value for `key_path`, must not be `None`')
		self._key_path=A
	@property
	def x_api_key(self):'Gets the x_api_key of this SydbankConnectorSettings.  # noqa: E501\n\n        API client key (obtained from BankData Developer Portal)  # noqa: E501\n\n        :return: The x_api_key of this SydbankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._x_api_key
	@x_api_key.setter
	def x_api_key(self,x_api_key):
		'Sets the x_api_key of this SydbankConnectorSettings.\n\n        API client key (obtained from BankData Developer Portal)  # noqa: E501\n\n        :param x_api_key: The x_api_key of this SydbankConnectorSettings.  # noqa: E501\n        :type: str\n        ';A=x_api_key
		if A is _A:raise ValueError('Invalid value for `x_api_key`, must not be `None`')
		self._x_api_key=A
	@property
	def payment_auth_redirect_uri(self):'Gets the payment_auth_redirect_uri of this SydbankConnectorSettings.  # noqa: E501\n\n        URI where clients are redirected to after payment authorization.  # noqa: E501\n\n        :return: The payment_auth_redirect_uri of this SydbankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._payment_auth_redirect_uri
	@payment_auth_redirect_uri.setter
	def payment_auth_redirect_uri(self,payment_auth_redirect_uri):'Sets the payment_auth_redirect_uri of this SydbankConnectorSettings.\n\n        URI where clients are redirected to after payment authorization.  # noqa: E501\n\n        :param payment_auth_redirect_uri: The payment_auth_redirect_uri of this SydbankConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._payment_auth_redirect_uri=payment_auth_redirect_uri
	@property
	def payment_auth_state(self):'Gets the payment_auth_state of this SydbankConnectorSettings.  # noqa: E501\n\n        This value returned to paymentAuthRedirectUri after payment authorization.  # noqa: E501\n\n        :return: The payment_auth_state of this SydbankConnectorSettings.  # noqa: E501\n        :rtype: str\n        ';return self._payment_auth_state
	@payment_auth_state.setter
	def payment_auth_state(self,payment_auth_state):'Sets the payment_auth_state of this SydbankConnectorSettings.\n\n        This value returned to paymentAuthRedirectUri after payment authorization.  # noqa: E501\n\n        :param payment_auth_state: The payment_auth_state of this SydbankConnectorSettings.  # noqa: E501\n        :type: str\n        ';self._payment_auth_state=payment_auth_state
	def to_dict(D):
		...
		if issubclass(SydbankConnectorSettings,dict):
	...
	def __eq__(B,other):
		...
		if not isinstance(A,SydbankConnectorSettings):return False
