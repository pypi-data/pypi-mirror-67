...
class Device(object):
    ...
    def adb_command(self, cmd):
        return Command(self.make_cmd(cmd))
    ...
    def rm(self, path):
        ...
        删除文件
        """
        self.adb_command('adb shell rm -rf ' + path).close()
    ...
    def get_layout_xml(self, path):
        self.adb_command('adb shell uiautomator dump --compressed /data/local/tmp/LayoutXml.xml').close()
        self.adb_command('adb pull /data/local/tmp/LayoutXml.xml ' + PATH(path)).close()
        self.adb_command('adb shell rm -r /data/local/tmp/LayoutXml.xml').close()
    ...
    def get_screencap(self, path=None):
        ...
        :return: file <png>
        """
        self.adb_command('adb shell /system/bin/screencap -p /sdcard/screencap.png').close()
        if path is None:
            self.adb_command('adb pull /sdcard/screencap.png ./screencap.png').close()
        else:
            self.adb_command('adb pull /sdcard/screencap.png ' + path).close()
        self.adb_command("adb shell rm /sdcard/screencap.png").close()
    ...
    def click(self, x, y):
        ...
        :return:None
        """
        self.adb_command('adb shell input tap %s %s' % (x, y)).close()
    ...
    def swipe(self, x, y, x1, y1):
        ...
        :return:
        """
        self.adb_command('adb shell input swipe %s %s %s %s' % (x, y, x1, y1)).close()
    ...
    def long_click(self, x, y):
        ...
        :return:
        """
        self.adb_command('adb shell input swipe %s %s %s %s 2000' % (x, y, x, y)).close()
    ...
    def input(self, text):
        ...
        :return:
        """
        self.adb_command('adb shell input text ' + text).close()
    ...
    def click_keycode(self, keycode):
        ...
        :return:
        """
        self.adb_command('adb shell input keyevent ' + keycode).close()
    ...
    def long_click_keycode(self, keycode):
        ...
        :return:
        """
        self.adb_command('input keyevent --longpress ' + keycode).close()
    ...
    def install_app(self, apk_path):
        ...
        :return:
        """
        self.adb_command('adb install -r ' + apk_path).close()
    ...
    def stop_app(self, package):
        ...
        :return:
        """
        self.adb_command('adb shell am force-stop ' + package).close()
    ...
    def start_app(self, package, activity):
        ...
        :return:
        """
        self.adb_command('adb shell am start ' + package + '/' + activity).close()
    ...
    def app_clear_data(self, package):
        ...
        :return:
        """
        self.adb_command('adb shell pm clear ' + package).close()

    def wifi_stop(self):
        """
        wifi stop
        """
        self.adb_command('adb shell svc wifi disable').close()

    def wifi_start(self):
        """
        wifi start
        """
        self.adb_command('adb shell svc wifi enable').close()
    ...
    def p_SERIAL(self, package):
        ...
        :return:p_SERIAL
        """
        rtu = self.adb_command("adb shell \"ps |grep " + package + " |grep -v :\"").read_close()
        if rtu == "":
    ...
    def get_focused_package_activity(self):
        ...
        out = self.adb_command("adb shell dumpsys window w | " + find_util + " \/| " + find_util + " _NAME=").read_close()
    ...
    def clear_log(self):
        ...
        清除设备日志缓存
        """
        self.adb_command("adb shell logcat -c").close()
    ...
    def get_log(self, grep=None, f_NAME=None):
        ...
        if f_NAME is not None:
            cmd_text += "> " + f_NAME
            self.adb_command(cmd_text).close()
        else:
            return self.adb_command(cmd_text).close()
