...
class OutputPrinter:
    ...
    def json(violations, counts):
        ...
        """
        print(json_dumps(OutputPrinter._build_output(violations, counts)))

    @staticmethod
    def yaml(violations, counts):
        ...
        :param counts: Dict of counts of violations keyed by severity.
        """
        print(yaml_dump(OutputPrinter._build_output(violations, counts)))

    @staticmethod
    def text(violations, counts):
...
{left_margin} To resolve:""")
            ...
            print()
            print(f'{BCOLORS["HEADER"]}{"Report":30}{BCOLORS["ENDC"]}')
            print(''.rjust(30, '-'))
    ...
    @staticmethod
    def _build_output(violations, counts):
