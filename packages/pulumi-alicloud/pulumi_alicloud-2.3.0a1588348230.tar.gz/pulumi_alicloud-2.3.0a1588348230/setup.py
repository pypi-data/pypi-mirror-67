...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.3.0-alpha.1588348230+gcb16b40'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.3.0-alpha.1588348230+gcb16b40`
                """)
            else:
                raise
