...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', 'v2.2.0-alpha.1588030851+g478dfd6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud v2.2.0-alpha.1588030851+g478dfd6`
                """)
            else:
                raise
