...
from .bio_explorer import BioExplorer, MeshDescriptor, ProteinDescriptor, GlycansDescriptor, RNASequenceDescriptor
...
__all__ = ['CircuitExplorer', 'DiffuseTensorImaging', 'GraphExplorer', 'CameraPathHandler', 'Widgets',
           'BioExplorer', 'MeshDescriptor', 'ProteinDescriptor', 'GlycansDescriptor', 'RNASequenceDescriptor',
           '__version__']
