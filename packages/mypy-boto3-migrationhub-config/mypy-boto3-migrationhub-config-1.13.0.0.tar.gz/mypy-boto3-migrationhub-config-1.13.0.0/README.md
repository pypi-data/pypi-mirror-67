...
[boto3.MigrationHubConfig 1.13.0](https://boto3.amazonaws.com/v1/documentation/api/1.13.0/reference/services/migrationhub-config.html#MigrationHubConfig) service
