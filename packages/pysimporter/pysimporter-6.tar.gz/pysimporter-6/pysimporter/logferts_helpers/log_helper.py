...
class LogHelper:
    ...
    def __init__(self, log_dir_path, logger_name=None, log_level=None, file_name=None, log_dir_name=None,
                 enable_console_log_mode=False):
    ...
    def _set_logger_preferences(self) -> None:
        ...
        if self._enable_console_log_mode:
            ...
            if not self._file_name:
                self._file_name = 'log'
            filename = '{}/{}_{}.log'.format(self._log_dir_path, self._file_name, strftime("%Y-%m-%d-%H-%M",
                                                                                                 gmtime()))
    ...
    def _create_log_directory(self) -> None:
        ...
        self._log_dir_path = path.join(path.dirname(path.dirname(__file__)), self._log_dir_name)
