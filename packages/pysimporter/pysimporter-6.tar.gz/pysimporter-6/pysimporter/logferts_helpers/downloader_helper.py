...
class Downloader:
    ...
    def __init__(self, logger, use_proxy=True, use_session=False, error_status_codes=None) -> None:
        self.attempts = 5
    ...
    def create_request(self, method, url, params={}, data={}, cookies={}, headers={}, timeout=60, return_response=False,
        ...
        while attempts > 0:
            ...
            attempts -= 1
            raw_proxy = '//138.197.49.55:50000' if self.use_proxy else None
            try:
    ...
    def load_user_agents(self) -> List:
        ...
        csv_file = path.join(cd, 'valid_user_agents.csv')
    ...
    def get_user_agent(self) -> Union[str, List]:
        ...
        try:
            ...
            self.logger.write(40, 'Cannot get user-agent')
            return ''
