...
class TreeFlushPermTestCase(TestCase):
    def setUp(self):
        ...
        self.dept_1_1 = Dept.valid_objects.create(uid='1_1', parent=self.dept_1)
        self.dept_1_2 = Dept.valid_objects.create(uid='1_2', parent=self.dept_1)
        self.dept_1_1_1 = Dept.valid_objects.create(uid='1_1_1', parent=self.dept_1_1)
        self.dept_1_1_2 = Dept.valid_objects.create(uid='1_1_2', parent=self.dept_1_1)
        self.dept_1_1_3 = Dept.valid_objects.create(uid='1_1_3', parent=self.dept_1_1)
        self.dept_2 = Dept.valid_objects.create(uid='2', parent=self.root)
        self.dept_2_1 = Dept.valid_objects.create(uid='2_1', parent=self.dept_2)
        self.dept_2_2 = Dept.valid_objects.create(uid='2_2', parent=self.dept_2)
    ...
    def test_tree_front_walker(self):
        self.assertEqual(list(self.root.tree_front_walker()), self.front_walker_depts)

    def test_dept_status(self):
        DeptPerm.valid_objects.get(owner=self.root, perm=self.perm).update_status(1)
        res = [DeptPerm.valid_objects.get(owner=dept, perm=self.perm).value for dept in self.front_walker_depts]
        expect = [
            True,
            True,
            True,
        ...
        DeptPerm.valid_objects.get(owner=self.root, perm=self.perm).update_status(0)
        res = [DeptPerm.valid_objects.get(owner=dept, perm=self.perm).value for dept in self.front_walker_depts]
        expect = [
            False,
            False,
        ...
        DeptPerm.valid_objects.get(owner=self.dept_1, perm=self.perm).update_status(1)
        res = [DeptPerm.valid_objects.get(owner=dept, perm=self.perm).value for dept in self.front_walker_depts]
        expect = [
            False,
            True,
        ...
        DeptPerm.valid_objects.get(owner=self.dept_1_1, perm=self.perm).update_status(0)
        res = [DeptPerm.valid_objects.get(owner=dept, perm=self.perm).value for dept in self.front_walker_depts]
        expect = [
            False,
            True,
