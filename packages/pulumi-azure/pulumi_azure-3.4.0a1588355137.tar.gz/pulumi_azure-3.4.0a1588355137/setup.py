...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.4.0-alpha.1588355137+ge0d37fdc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.4.0-alpha.1588355137+ge0d37fdc`
                """)
            else:
                raise
