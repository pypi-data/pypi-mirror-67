...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v3.5.0-alpha.1588614830+gb5c21cb6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v3.5.0-alpha.1588614830+gb5c21cb6`
                """)
            else:
                raise
