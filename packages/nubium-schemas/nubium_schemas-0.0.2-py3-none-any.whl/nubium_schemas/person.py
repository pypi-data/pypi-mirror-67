    ...
    "name": "privacy",
   	...
   	"fields": [
            {"name": "consent_email_marketing", "type": "string", "default": ""},
          		{"name": "consent_email_marketing_timestamp",
          		    "type": "string", "default": ""},
          		{"name": "consent_email_marketing_source",
          		    "type": "string", "default": ""},
          		{"name": "consent_share_to_partner", "type": "string", "default": ""},
          		{"name": "consent_share_to_partner_timestamp",
          		    "type": "string", "default": ""},
          		{"name": "consent_share_to_partner_source",
          		    "type": "string", "default": ""}
        ]
}
    ...
    "name": "tracking_ids",
   	...
   	"fields": [
            {"name": "eloqua_contact_id", "type": "string", "default": ""},
          		{"name": "sfdc_lead_ids", "type": {"type": "array",
                                               "items": sfdc_lead_id_schema, "default": []}},
          		{"name": "sfdc_contact_ids", "type": {"type": "array",
                                                  "items": sfdc_contact_id_schema, "default": []}},
        ]
}
