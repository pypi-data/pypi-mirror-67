...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.2.0-alpha.1588062026+g61c5f801'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.2.0-alpha.1588062026+g61c5f801`
                """)
            else:
                raise
