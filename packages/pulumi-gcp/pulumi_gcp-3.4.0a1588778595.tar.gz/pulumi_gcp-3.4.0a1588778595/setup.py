...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.4.0-alpha.1588778595+gd9a88adc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.4.0-alpha.1588778595+gd9a88adc`
                """)
            else:
                raise
