...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v3.3.0-alpha.1588234523+gefdb418f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v3.3.0-alpha.1588234523+gefdb418f`
                """)
            else:
                raise
