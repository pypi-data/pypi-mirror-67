""" PIPE DATA TXT - Verison 1.0.0
    ...
    A text file: Can have header information, the data is stored in lines.
    
    Header: Any line that starts with a # followed by a keyword and ':' or '='
            All header values are imported as strings
    
    Data: A list of all the lines
    
    Saving order: When saving the header values will be stored before the
                  data lines.
...
import re
import time
from darepype.drp import DataParent # Pipe Data Parent
