...
def parse_arguments():
    ...
    parser.add_argument("-i", "--ios", dest="ios_version",
                        help="iOS version for the said file")
    ...
    parser.add_argument("--ip", dest='ip_addr',
                        help="specify ip address of gidaes server")
    parser.add_argument("--download", action='store_true',
                        help="download firmware image")
