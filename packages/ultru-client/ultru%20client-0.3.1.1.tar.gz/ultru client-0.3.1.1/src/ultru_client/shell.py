...
from .utils.globals import CLI_GLOBALS
...
| |_| | |____| | | |\ \| |_| |
 \___/\_____/\_/ \_| \_|\___/
    ...
    remove_parser.add_argument('queries', nargs='+', choices_method=remove_options, help="Remove query or queries from your saved cache")
    ...
    update_parser.add_argument('jobs', help="Sync jobs with API")
