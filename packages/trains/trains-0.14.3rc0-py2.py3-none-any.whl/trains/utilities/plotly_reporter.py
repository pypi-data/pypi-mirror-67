...
def create_2d_histogram_plot(np_row_wise, labels, title=None, xtitle=None, ytitle=None, series=None, xlabels=None,
    ...
    :param mode: multiple histograms mode. valid options are: stack / group / relative
...
def _plotly_hist_dict(title, xtitle, ytitle, mode='stack', data=None, comment=None):
    """
    Create a basic Plotly chart dictionary
    :param title: Chart title
    :param xtitle: X-Series title
    :param ytitle: Y-Series title
    :param mode: multiple histograms mode. optionals stack / group / relative
