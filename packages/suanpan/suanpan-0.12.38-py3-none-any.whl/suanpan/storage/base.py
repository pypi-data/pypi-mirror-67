...
class Storage(HasName):
    ...
    def getKeyInAppDataStore(self, *paths):
        return self.storagePathJoin("studio", g.userId, "data", g.appId, *paths)

    def getKeyInAppConfigsStore(self, *paths):
        return self.storagePathJoin("studio", g.userId, "configs", g.appId, *paths)

    def getKeyInNodeDataStore(self, *paths):
        return self.storagePathJoin(
            "studio", g.userId, "data", g.appId, g.nodeId, *paths
        )

    def getKeyInNodeConfigsStore(self, *paths):
        return self.storagePathJoin(
            "studio", g.userId, "configs", g.appId, g.nodeId, *paths
        )
    ...
    def getKeyInNodeLogsStore(self, *paths):
        return self.storagePathJoin(
            "studio", g.userId, "logs", g.appId, g.nodeId, *paths
        )
