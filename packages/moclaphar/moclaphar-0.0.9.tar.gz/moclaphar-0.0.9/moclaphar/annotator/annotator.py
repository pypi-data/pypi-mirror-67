...
def run_application(video_path_, data_path_, v_width=640):
    root = tk.Tk()
...
if __name__ == '__main__':
    ...
    if args.video_path == "" or args.data_path == "":
        video_path = filedialog.askopenfilename(initialdir='./', title="Select the video file")
        data_path = filedialog.askopenfilename(initialdir='./', title="Select the csv or mat file",
    ...
    run_application(video_path, data_path, v_width=args.vw)
