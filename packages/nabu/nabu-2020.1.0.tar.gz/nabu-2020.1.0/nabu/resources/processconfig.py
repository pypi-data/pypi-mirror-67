    ...
    def build_processing_steps(self):
        ...
        if nabu_config["reconstruction"]["method"] != None:
            ...
            options["reconstruction"] = copy_dict_items(
                nabu_config["reconstruction"],
                ["method", "angles_file", "rotation_axis_position", "axis_correction_file",
                "angle_offset", "fbp_filter_type", "padding_type", "enable_halftomo",
                "start_x", "end_x", "start_y", "end_y", "start_z", "end_z"]
            )
            options["reconstruction"]["axis_correction"] = dataset_infos.axis_correction
            options["reconstruction"]["angles"] = dataset_infos.reconstruction_angles
            options["reconstruction"]["radio_dims_y_x"] = dataset_infos.radio_dims[::-1]
            options["reconstruction"]["pixel_size_cm"] = dataset_infos.pixel_size * 1e-4 # pix size is in microns
