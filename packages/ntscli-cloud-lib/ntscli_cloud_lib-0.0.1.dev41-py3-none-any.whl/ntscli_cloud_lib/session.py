...
class Session:
    ...
    def check_broker(self):
        """Use the self-responder to check whether the broker is responding."""
    ...
    def run_plan(self, plan: Dict, check: bool = False) -> Dict:
        ...
        The caller can request a basic sanity check of the plan before being sent on. If set, errors will be surfaced as SyntaxError.

        :param check: If true, throw a syntax error if the test fails to pass a sanity check.
    ...
    def get_eyepatch_connected_esn_list(self, rae: str) -> List[str]:
        ...
        :@param: rae the rae to ask for connections from
    ...
    def is_esn_connected_to_eyepatch(self, rae: str, esn: str) -> bool:
        ...
        :param rae: The ESN of the device we are interested in. Note that this is not using the DeviceIdentifier.
        :return:
        """
    ...
    def status(self, rae: str, **kwargs) -> Dict:
        ...
        This returns data in one of two shapes:
