...
from messages import request_pb2 as messages_dot_request__pb2
...
_APPROVAL_META.fields_by_name['approver'].message_type = models_dot_user__pb2._USER
_APPROVAL_META.containing_type = _APPROVAL
_APPROVAL.fields_by_name['id'].message_type = models_dot_uuid__pb2._UUID
_APPROVAL.fields_by_name['schema'].message_type = models_dot_schema__pb2._SCHEMA
_APPROVAL.fields_by_name['request'].message_type = messages_dot_request__pb2._REQUEST
...
Approval = _reflection.GeneratedProtocolMessageType('Approval', (_message.Message,), {
  ...
  'Meta' : _reflection.GeneratedProtocolMessageType('Meta', (_message.Message,), {
    ...
    '__module__' : 'messages.approval_pb2'
