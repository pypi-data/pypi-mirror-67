...
from enums import service_pb2 as enums_dot_service__pb2
...
_USER_IDENTITY.fields_by_name['service'].enum_type = enums_dot_service__pb2._SERVICE
_USER_IDENTITY.containing_type = _USER
_USER.fields_by_name['uuid'].message_type = models_dot_uuid__pb2._UUID
