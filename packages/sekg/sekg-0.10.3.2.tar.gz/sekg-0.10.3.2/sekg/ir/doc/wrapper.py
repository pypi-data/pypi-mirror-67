...
class PreprocessMultiFieldDocumentCollection(gensim.utils.SaveLoad):
    ...
    def __init__(self, preprocessor: Preprocessor):
        """
        if not Preprocessor is given, CodeDocPreprocessor is used.
        :param preprocessor: one instance of Preprocessor subclass.
        """
        ...
        if preprocessor is None:
            ...
            self.preprocessor = CodeDocPreprocessor()
            return
    ...
    @staticmethod
    def create_from_doc_collection_with_default_preprocessor(doc_collection: MultiFieldDocumentCollection):
        """
        create the preprocessed document collection
        :param doc_collection: the document collection need to preprocess
        :return: PreprocessMultiFieldDocumentCollection
        """
        pre_doc_collection = PreprocessMultiFieldDocumentCollection(preprocessor=None)
        pre_doc_collection.add_raw_doc_collection(doc_collection)
        return pre_doc_collection
