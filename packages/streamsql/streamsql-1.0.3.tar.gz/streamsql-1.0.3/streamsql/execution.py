...
class Executor:
    ...
    def add_to_lookup(self, table, key, value):
        ...
        requests.post(self.host + "/api/lookup/values?table="+table, data=data, headers=headers)
    ...
    def delete_from_lookup(self, table, key):
        ...
        requests.delete(self.host + "/api/lookup/values?table="+table, data=data, headers=headers)
...
class Transformation:
    ...
    def lookup(self, table, field):
        ...
        self.__lookup['field'] = table
        self.__lookup['name'] = field
