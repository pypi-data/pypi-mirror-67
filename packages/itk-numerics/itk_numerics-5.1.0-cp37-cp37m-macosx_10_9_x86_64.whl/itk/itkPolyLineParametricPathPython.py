...
class itkPolyLineParametricPath2(itkParametricPathPython.itkParametricPath2):
    ...
    def AddVertex(self, vertex: 'itkContinuousIndexD2') -> "void":
        ...
        ** Evaluate the first
        derivative of the ND output with respect to the 1D

        Add a vertex (and a connecting line segment to the previous vertex).
        Adding a vertex has the additional effect of extending the domain of
        the PolyLineParametricPath by 1.0 (each pair of consecutive vertices
        is separated by one unit of input). 
        """
