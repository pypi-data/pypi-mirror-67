...
from mingdongtextsim.bert import modeling
from mingdongtextsim.bert import tokenization
from mingdongtextsim.bert.graph import optimize_graph
...
if __name__ == "__main__":
    vector = BertVector(model_dir=os.path.join(mingdongtextsim.USER_DATA_DIR, 'chinese_L-12_H-768_A-12'),
                        output_dir=os.path.join(mingdongtextsim.USER_DATA_DIR, 'bert_vector'))
