...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v2.1.0-alpha.1588030341+ged23d23'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v2.1.0-alpha.1588030341+ged23d23`
                """)
            else:
                raise
