...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v2.1.0-alpha.1588062654+gbe38159'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v2.1.0-alpha.1588062654+gbe38159`
                """)
            else:
                raise
