...
import mingdongnlp
import mingdongnlp.version
from mingdongnlp.callbacks.fine_csv_logger import FineCSVLogger
from mingdongnlp.common.structure import SerializableDict
from mingdongnlp.common.transform import Transform
from mingdongnlp.common.vocab import Vocab
from mingdongnlp.metrics.chunking.iobes import IOBES_F1
from mingdongnlp.optimizers.adamw.optimization import AdamWeightDecay
from mingdongnlp.utils import io_util
from mingdongnlp.utils.io_util import get_resource, tempdir_human, save_json, load_json
from mingdongnlp.utils.log_util import init_logger, logger
from mingdongnlp.utils.reflection import class_path_of, str_to_type
from mingdongnlp.utils.string_util import format_metrics, format_scores
from mingdongnlp.utils.tf_util import size_of_dataset, summary_of_model, get_callback_by_class
from mingdongnlp.utils.time_util import Timer, now_datetime
from mingdongnlp.utils.util import merge_dict
...
class Component(ABC):
    ...
    def __init__(self) -> None:
        ...
        self.meta = {
            ...
            'hanlp_version': mingdongnlp.version.__version__,
        }
...
class KerasComponent(Component, ABC):
    ...
    def load(self, save_dir: str, logger=mingdongnlp.utils.log_util.logger, **kwargs):
