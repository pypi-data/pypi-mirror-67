...
from mingdongnlp.layers.embeddings.char_cnn import CharCNNEmbedding
from mingdongnlp.layers.embeddings.char_rnn import CharRNNEmbedding
from mingdongnlp.layers.embeddings.concat_embedding import ConcatEmbedding
from mingdongnlp.layers.embeddings.contextual_string_embedding import ContextualStringEmbedding
from mingdongnlp.layers.embeddings.fast_text import FastTextEmbedding
from mingdongnlp.layers.embeddings.word2vec import Word2VecEmbeddingV1, Word2VecEmbedding, StringWord2VecEmbedding
        ...
        if embeddings_require_string_input(embeddings):
            ...
            for embed in embeddings:
                if embed['class_name'].split('>')[-1] == Word2VecEmbedding.__name__:
                    embed['class_name'] = 'mingdongnlp>' + StringWord2VecEmbedding.__name__
