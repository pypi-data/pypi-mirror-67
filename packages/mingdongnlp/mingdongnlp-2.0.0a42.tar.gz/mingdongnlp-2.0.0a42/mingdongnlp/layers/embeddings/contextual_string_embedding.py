...
import numpy as np
from mingdongnlp.components.rnn_language_model import RNNLanguageModel
from mingdongnlp.common.constant import PAD
from mingdongnlp.utils.io_util import get_resource
from mingdongnlp.utils.tf_util import copy_mask, hanlp_register, str_tensor_2d_to_list
from mingdongnlp.utils.util import infer_space_after
