...
from mingdongnlp.layers.transformers import zh_albert_models_google
from mingdongnlp.utils.io_util import get_resource, stdout_redirected, hanlp_home
...
def build_transformer(transformer, max_seq_length, num_labels, tagging=True, tokenizer_only=False):
    ...
    if transformer in zh_albert_models_google:
        ...
        from mingdongnlp.layers.transformers.albert_tokenization import FullTokenizer
