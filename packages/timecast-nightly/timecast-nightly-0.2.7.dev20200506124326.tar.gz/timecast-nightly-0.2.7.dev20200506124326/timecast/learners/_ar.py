...
class AR(NewMixin, FitMixin, flax.nn.Module):
    ...
    def apply(
        ...
        (fit_intercept, constrain): params, history, history.T @ params
        h: history_len
        i: input_dim
        o: output_dim

        (True, True): (h + 1, o), (h + 1, i), (i, o)
        (True, False): (h * i + 1, o), (h * i + 1, 1), (1, o)
        (False, True): (h, o), (h, i), (i, o)
        (False, False): (h * i, o), (h * i, 1), (1, o)

        (True, True): (h + 1, 1), (h + 1, i), (i, 1)
        (True, False): (h * i + 1, o), (h * i + 1, 1), (1, o)
        (False, True): (h, 1), (h, i), (i, 1)
        (False, False): (h * i, o), (h * i, 1), (1, o)
        ...
        Args:
            ...
            constrain: constrain regression
        ...
        if not constrain:
            inputs = inputs.ravel().reshape(1, -1)
    ...
    def fit(
        ...
        **kwargs
        ...
        Args:
            ...
            constrain: matrix-AR TODO: needs more doc
        ...
        kernel, bias = fit_gram(
            XTX, XTY, normalize=normalize, input_dim=(input_dim if constrain else None), alpha=alpha
        )
        ...
        if normalize:
            ...
            scale = XTX.std
            if constrain:
                loc = loc.reshape(history_len, input_dim)
                scale = scale.reshape(history_len, input_dim)
