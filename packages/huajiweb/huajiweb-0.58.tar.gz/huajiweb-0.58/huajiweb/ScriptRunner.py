...
from huajiweb import magic
from huajiweb import source_util
from huajiweb.ReportThread import ReportThread
...
from huajiweb.widgets import Widgets
...
class ScriptRunner(object):
    def __init__(
        ...
        widget_states : huajiweb.proto.Widget_pb2.WidgetStates
    ...
    def _run_script(self, rerun_data):
        ...
        try:
            ...
            # Show exceptions in the huajiweb report.
            LOGGER.debug(e)
