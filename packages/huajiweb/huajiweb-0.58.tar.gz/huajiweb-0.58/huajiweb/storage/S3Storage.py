...
from huajiweb.storage.AbstractStorage import AbstractStorage
...
class S3Storage(AbstractStorage):
    ...
    def __init__(self):
        ...
        # URL where browsers go to load the huajiweb web app.
    ...
    def _s3_init(self):
        ...
        try:
            ...
            LOGGER.error(
                ...
                '"s3.profile" in your huajiweb configuration.'
            )
