...
REPORT_CONTEXT_ATTR_NAME = "huajiweb_report_ctx"
...
class ReportThread(threading.Thread):
    ...
    def __init__(
        ...
        self.huajiweb_report_ctx = ReportContext(
...
def get_report_ctx():
    ...
    if ctx is None and huajiweb._is_running_with_huajiweb:
        # Only warn about a missing ReportContext if we were started
        # via `huajiweb run`. Otherwise, the user is likely running a
        # script "bare", and doesn't need to be warned about huajiweb
