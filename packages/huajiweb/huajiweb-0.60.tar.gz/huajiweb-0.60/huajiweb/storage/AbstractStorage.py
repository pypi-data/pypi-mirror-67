...
def _get_static_dir():
    """Return the path to lib/huajiweb/static.
    ...
    huajiweb_dir = os.path.normpath(os.path.join(module_dir, ".."))

    return os.path.normpath(os.path.join(huajiweb_dir, "static"))
...
def _get_static_files(static_dir):
    ...
    ----------
    static_dir : str
        The path to lib/huajiweb/static.
