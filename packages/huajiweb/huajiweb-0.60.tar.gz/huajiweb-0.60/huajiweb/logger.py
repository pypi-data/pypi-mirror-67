...
def setup_formatter(logger):
    ...
    if hasattr(logger, "huajiweb_console_handler"):
        logger.removeHandler(logger.huajiweb_console_handler)

    logger.huajiweb_console_handler = logging.StreamHandler()
    ...
    if development.is_development_mode:
        ...
        logger.huajiweb_console_handler.setFormatter(formatter)

    # Register the new console logger.
    logger.addHandler(logger.huajiweb_console_handler)
