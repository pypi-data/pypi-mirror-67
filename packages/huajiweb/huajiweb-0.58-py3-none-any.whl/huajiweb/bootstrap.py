...
from huajiweb.server.Server import Server
...
def _fix_matplotlib_crash():
    ...
    Mac-only. Consistency within huajiweb seemed more important.
    """
    if config.get_option("runner.fixMatplotlib"):
        try:
            ...
            #  need to run without consulting huajiweb.config.get_option,
            #  because this would import huajiweb, and therefore matplotlib.
            import matplotlib
...
def _fix_sys_argv(script_path, args):
    """sys.argv needs to exclude huajiweb arguments and parameters
...
def _print_url():
    title_message = "You can now view your huajiweb app in your browser."
    named_urls = []
