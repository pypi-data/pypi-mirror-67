...
from huajiweb.ReportQueue import ReportQueue
from huajiweb import net_util

from huajiweb.logger import get_logger
from huajiweb.proto.StaticManifest_pb2 import StaticManifest
...
class Report(object):
    ...
    def get_url(cls, host_ip):
        ...
        ----------
        host_ip : str
            The IP address of the machine that is running the huajiweb Server.
