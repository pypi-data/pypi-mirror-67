...
# source: huajiweb/proto/Initialize.proto
...
_ENVIRONMENTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='huajiweb_version', full_name='EnvironmentInfo.huajiweb_version', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_INITIALIZE.fields_by_name['session_state'].message_type = huajiweb_dot_proto_dot_SessionState__pb2._SESSIONSTATE
...
Initialize = _reflection.GeneratedProtocolMessageType('Initialize', (_message.Message,), {
  ...
  '__module__' : 'huajiweb.proto.Initialize_pb2'
