...
from huajiweb import caching
from huajiweb import config
from huajiweb import cursor
from huajiweb import type_util
from huajiweb.ReportThread import get_report_ctx
from huajiweb.errors import DuplicateWidgetID
from huajiweb.errors import huajiwebAPIException
from huajiweb.errors import NoSessionContext
from huajiweb.file_util import get_encoded_file_data
from huajiweb.js_number import JSNumber
from huajiweb.js_number import JSNumberBoundsException
from huajiweb.proto import Alert_pb2
from huajiweb.proto import Balloons_pb2
from huajiweb.proto import BlockPath_pb2
from huajiweb.proto import ForwardMsg_pb2
from huajiweb.proto.NumberInput_pb2 import NumberInput
from huajiweb.proto.TextInput_pb2 import TextInput
...
# List of huajiweb commands that perform a Pandas "melt" operation on
# input dataframes.
...
class DeltaGenerator(object):
    ...
    def __init__(self, container=BlockPath_pb2.BlockPath.MAIN, cursor=None):
        """Inserts or updates elements in huajiweb apps.
        ...
        update the element `foo` that appears in the huajiweb app.
    ...
    def __getattr__(self, name):
        ...
        def wrapper(*args, **kwargs):
            if name in huajiweb_methods:
                ...
                message = "`%(name)s()` is not a valid huajiweb command." % {
                    "name": name
                }

            raise huajiwebAPIException(message)
    ...
    def text(self, element, body):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=PYxU1kee5ubuhGR11NsnT1
           height: 50px
    ...
    def markdown(self, element, body, unsafe_allow_html=False):
        ...
        Example
        -------
        >>> st.markdown('huajiweb is **_really_ cool**.')

        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=PXz9xgY8aB88eziDVEZLyS
           height: 50px
    ...
    def latex(self, element, body):
        ...
        .. output::
           https://share.huajiweb.io/0.50.0-td2L/index.html?id=NJFsy6NbGTsH2RF9W6ioQ4
           height: 75px
    ...
    def code(self, element, body, language="python"):
        ...
        -------
        >>> code = '''def hello():
        ...     print("Hello, huajiweb!")'''
        >>> st.code(code, language='python')

        .. output::
           https://share.huajiweb.io/0.27.0-kBtt/index.html?id=VDRnaCEZWSBCNUd5gNQZv2
           height: 100px
    ...
    def json(self, element, body):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=CTFkMQd89hw3yZbZ4AUymS
           height: 280px
    ...
    def title(self, element, body):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=SFcBGANWd8kWXF28XnaEZj
           height: 100px
    ...
    def header(self, element, body):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=AnfQVFgSCQtGv6yMUMUYjj
           height: 100px
    ...
    def subheader(self, element, body):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=LBKJTfFUwudrbWENSHV6cJ
           height: 100px
    ...
    def help(self, element, obj):
        ...
        """
        import huajiweb.elements.doc_string as doc_string
    ...
    def exception(self, element, exception):
        ...
        """
        import huajiweb.elements.exception_proto as exception_proto
    ...
    def dataframe(self, data=None, width=None, height=None):
        ...
        data : pandas.DataFrame, pandas.Styler, numpy.ndarray, Iterable, dict,
            ...
            underyling DataFrame. huajiweb supports custom cell
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=165mJbzWdAC8Duf8a4tjyQ
           height: 330px
        ...
        .. output::
           https://share.huajiweb.io/0.29.0-dV1Y/index.html?id=Hb6UymSNuZDzojUNybzPby
           height: 285px

        """
        import huajiweb.elements.data_frame_proto as data_frame_proto
    ...
    def line_chart(
        ...
        .. output::
           https://share.huajiweb.io/0.50.0-td2L/index.html?id=BdxXG3MmrVBfJyqS2R2ki8
           height: 220px

        """

        import huajiweb.elements.altair as altair
    ...
    def area_chart(
        ...
        .. output::
           https://share.huajiweb.io/0.50.0-td2L/index.html?id=Pp65STuFj65cJRDfhGh4Jt
           height: 220px
    ...
    def bar_chart(
        ...
        .. output::
           https://share.huajiweb.io/0.50.0-td2L/index.html?id=5U5bjR2b3jFwnJdDfSvuRk
           height: 220px
    ...
    def vega_lite_chart(
        ...
        **kwargs : any
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=8jmmXR8iKoZGV4kXaKGYV5
           height: 200px

        Examples of Vega-Lite usage without huajiweb can be found at
        https://vega.github.io/vega-lite/examples/. Most of those can be easily
        translated to the syntax shown above.

        """
        import huajiweb.elements.vega_lite as vega_lite
    ...
    def graphviz_chart(
        ...
        .. output::
           https://share.huajiweb.io/0.56.0-xTAd/index.html?id=GBn3GXZie5K1kXuBKe4yQL
           height: 400px

        """
        import huajiweb.elements.graphviz_chart as graphviz_chart
    ...
    def plotly_chart(
        ...
        **kwargs
        ...
        sharing : {'huajiweb', 'private', 'secret', 'public'}
            Use 'huajiweb' to insert the plot and all its dependencies
            directly in the huajiweb app, which means it works offline too.
            This is the default.
            Use any other sharing mode to send the app to Plotly's servers,
            and embed the result into the huajiweb app. See
        ...
        **kwargs
        ...
        To show Plotly charts in huajiweb, just call `st.plotly_chart`
        ...
        .. output::
           https://share.huajiweb.io/0.56.0-xTAd/index.html?id=TuP96xX8JnsoQeUGAPjkGQ
           height: 400px
        ...
        import huajiweb.elements.plotly_chart as plotly_chart
    ...
    def pyplot(self, element, fig=None, clear_figure=None, **kwargs):
        ...
        **kwargs : any
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=PwzFN7oLZsvb6HDdwdjkRB
           height: 530px

        Notes
        -----
        Matplotlib support several different types of "backends". If you're
        getting an error using Matplotlib with huajiweb, try setting your
        backend to "TkAgg"::
        ...
        """
        import huajiweb.elements.pyplot as pyplot
    ...
    def bokeh_chart(self, element, figure, use_container_width=False):
        ...
        To show Bokeh charts in huajiweb, just call `st.bokeh_chart`
        ...
        .. output::
           https://share.huajiweb.io/0.56.0-xTAd/index.html?id=Fdhg51uMbGMLRRxXV6ubzp
           height: 600px

        """
        import huajiweb.elements.bokeh_chart as bokeh_chart
    ...
    def image(
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=YCFaqPgmgpEz7jwE4tHAzY
           height: 630px
        ...
        if use_column_width:
            ...
            raise huajiwebAPIException("Image width must be positive.")
    ...
    def audio(self, element, data, format="audio/wav", start_time=0):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=Dv3M9sA7Cg8gwusgnVNTHb
           height: 400px
    ...
    def video(self, element, data, format="video/mp4", start_time=0):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=Wba9sZELKfKwXH4nDCCbMv
           height: 600px
    ...
    def slider(
        ...
        # we simply re-package as huajiwebAPIExceptions.
        ...
        try:
            ...
            raise huajiwebAPIException(str(e))
    ...
    def map(self, element, data=None, zoom=None, use_container_width=True):
        ...
        https://docs.huajiweb.io/cli.html#view-all-config-options for more
        ...
        .. output::
           https://share.huajiweb.io/0.53.0-SULT/index.html?id=9gTiomqPEbvHY2huTLoQtH
           height: 600px

        """
        import huajiweb.elements.map as huajiweb_map

        element.deck_gl_json_chart.json = huajiweb_map.to_deckgl_json(data, zoom)
    ...
    def deck_gl_chart(self, element, spec=None, use_container_width=False, **kwargs):
            ...
            - "layers": a list of dicts containing information to build a new
              Deck.GL layer in the map. Each layer accepts the following keys:
                ...
                - "type" : str
                  ...
                  by huajiweb: ArcLayer, GridLayer, HexagonLayer, LineLayer,
        ...
        **kwargs : any
        ...
        .. output::
           https://share.huajiweb.io/0.50.0-td2L/index.html?id=3GfRygWqxuqB5UitZLjz9i
           height: 530px
        ...
        import huajiweb.elements.deck_gl as deck_gl
    ...
    def pydeck_chart(self, element, pydeck_obj=None, use_container_width=False):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=ASTdExBpJ1WxbGceneKN1i
           height: 530px

        """
        import huajiweb.elements.deck_gl_json_chart as deck_gl_json_chart
    ...
    def table(self, element, data=None):
        ...
        .. output::
           https://share.huajiweb.io/0.25.0-2JkNY/index.html?id=KfZvDMprL4JFKXbpjD3fpq
           height: 480px
    ...
    def add_rows(self, data=None, **kwargs):
        ...
        **kwargs : pandas.DataFrame, numpy.ndarray, Iterable, dict, or None
        ...
        >>> # Now the table shown in the huajiweb app contains the data for
        ...
        >>> # Now the chart shown in the huajiweb app contains the data for
        >>> # df1 followed by the data for df2.
        ...
        if not self._cursor.is_locked:
            raise huajiwebAPIException("Only existing elements can `add_rows`.")
