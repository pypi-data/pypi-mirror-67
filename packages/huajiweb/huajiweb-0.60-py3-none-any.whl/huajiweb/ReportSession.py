...
from huajiweb import __installation_id__
from huajiweb import __version__
from huajiweb import caching
from huajiweb import config
from huajiweb import url_util
from huajiweb.MediaFileManager import media_file_manager
from huajiweb.UploadedFileManager import UploadedFileManager
from huajiweb.Report import Report
from huajiweb.ScriptRequestQueue import RerunData
from huajiweb.ScriptRequestQueue import ScriptRequest
from huajiweb.ScriptRequestQueue import ScriptRequestQueue
from huajiweb.ScriptRunner import ScriptRunner
from huajiweb.ScriptRunner import ScriptRunnerEvent
from huajiweb.credentials import Credentials
from huajiweb.logger import get_logger
from huajiweb.proto.ForwardMsg_pb2 import ForwardMsg
from huajiweb.proto.Widget_pb2 import WidgetStates
from huajiweb.server.server_util import serialize_forward_msg
from huajiweb.storage.S3Storage import S3Storage
from huajiweb.storage.FileStorage import FileStorage
from huajiweb.watcher.LocalSourcesWatcher import LocalSourcesWatcher
...
class ReportSession(object):
    ...
    def _on_scriptrunner_event(self, event, exception=None, widget_states=None):
        ...
        widget_states : huajiweb.proto.Widget_pb2.WidgetStates | None
        ...
        if event == ScriptRunnerEvent.SCRIPT_STARTED:
            ...
            if script_succeeded:
                ...
                from huajiweb.elements import exception_proto
    ...
    def _maybe_enqueue_initialize_message(self):
        ...
        imsg.environment_info.huajiweb_version = __version__
