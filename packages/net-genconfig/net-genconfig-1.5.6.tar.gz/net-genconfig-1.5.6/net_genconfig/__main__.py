...
def build_dict_helper(s):
    """Helper function to build a dictionary from a string: the lines
    of the string are parsed in the form 'key:value' and used to
    populate a dictionary that is returned.
...
global_helpers["build_dict"] = build_dict_helper



def build_list_helper(s):
    """Helper function to build a list from the lines in a multiline
...
global_helpers["build_list"] = build_list_helper
