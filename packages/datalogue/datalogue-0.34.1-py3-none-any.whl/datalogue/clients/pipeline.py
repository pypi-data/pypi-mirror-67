...
class _PipelineClient:
    ...
    def create(self, name: str, pipeline_def: PipelineDef) -> Union[DtlError, Pipeline]:
        """
    ...
    def update(self, pipeline_id: Union[str, UUID], name: Optional[str] = None, pipeline_def: Optional[PipelineDef] = None) -> Union[DtlError, Pipeline]:
        """
