...
class vnl_diag_matrixCF(object):
    ...
    def as_matrix(self) -> "vnl_matrixCF":
        """as_matrix(vnl_diag_matrixCF self) -> vnl_matrixCF"""
...
vnl_diag_matrixCF.as_matrix = new_instancemethod(_vnl_diag_matrixPython.vnl_diag_matrixCF_as_matrix, None, vnl_diag_matrixCF)
...
class vnl_diag_matrixD(object):
    ...
    def as_matrix(self) -> "vnl_matrixD":
        """as_matrix(vnl_diag_matrixD self) -> vnl_matrixD"""
...
vnl_diag_matrixD.as_matrix = new_instancemethod(_vnl_diag_matrixPython.vnl_diag_matrixD_as_matrix, None, vnl_diag_matrixD)
...
class vnl_diag_matrixF(object):
    ...
    def as_matrix(self) -> "vnl_matrixF":
        """as_matrix(vnl_diag_matrixF self) -> vnl_matrixF"""
...
vnl_diag_matrixF.as_matrix = new_instancemethod(_vnl_diag_matrixPython.vnl_diag_matrixF_as_matrix, None, vnl_diag_matrixF)
...
class vnl_diag_matrixLD(object):
    ...
    def as_matrix(self) -> "vnl_matrixLD":
        """as_matrix(vnl_diag_matrixLD self) -> vnl_matrixLD"""
...
vnl_diag_matrixLD.as_matrix = new_instancemethod(_vnl_diag_matrixPython.vnl_diag_matrixLD_as_matrix, None, vnl_diag_matrixLD)
...
class vnl_diag_matrixSI(object):
    ...
    def as_matrix(self) -> "vnl_matrixSI":
        """as_matrix(vnl_diag_matrixSI self) -> vnl_matrixSI"""
...
vnl_diag_matrixSI.as_matrix = new_instancemethod(_vnl_diag_matrixPython.vnl_diag_matrixSI_as_matrix, None, vnl_diag_matrixSI)
