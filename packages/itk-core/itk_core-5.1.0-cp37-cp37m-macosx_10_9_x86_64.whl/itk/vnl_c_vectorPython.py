...
def vnl_c_vectorSLL_allocate_Tptr(n: 'unsigned long const') -> "long long **":
    """vnl_c_vectorSLL_allocate_Tptr(unsigned long const n) -> long long **"""
    return _vnl_c_vectorPython.vnl_c_vectorSLL_allocate_Tptr(n)

def vnl_c_vectorSLL_allocate_T(n: 'unsigned long const') -> "long long *":
...
class vnl_c_vectorULL(object):
    ...
    def allocate_Tptr(n: 'unsigned long const') -> "unsigned long long **":
        """allocate_Tptr(unsigned long const n) -> unsigned long long **"""
        return _vnl_c_vectorPython.vnl_c_vectorULL_allocate_Tptr(n)

    allocate_Tptr = staticmethod(allocate_Tptr)

    def allocate_T(n: 'unsigned long const') -> "unsigned long long *":
...
def vnl_c_vectorULL_allocate_Tptr(n: 'unsigned long const') -> "unsigned long long **":
    """vnl_c_vectorULL_allocate_Tptr(unsigned long const n) -> unsigned long long **"""
    return _vnl_c_vectorPython.vnl_c_vectorULL_allocate_Tptr(n)

def vnl_c_vectorULL_allocate_T(n: 'unsigned long const') -> "unsigned long long *":
