...
class itkFunctionBaseDD(ITKCommonBasePython.itkObject):
    ...
    def Evaluate(self, input: 'double const &') -> "double":
        """
        Evaluate(itkFunctionBaseDD self, double const & input) -> double
    ...
    def cast(obj: 'itkLightObject') -> "itkFunctionBaseDD *":
...
def itkFunctionBaseDD_cast(obj: 'itkLightObject') -> "itkFunctionBaseDD *":
