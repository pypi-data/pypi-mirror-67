...
def main() -> None:
    ...
    subparse = parser.add_subparsers(help='action subcommands')
    parser.add_argument("path", help="path to python module source file")
    parser.add_argument("-o", "--offset", type=int, help="""
