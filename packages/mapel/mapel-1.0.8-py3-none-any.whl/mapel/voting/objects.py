...
class Model_2d(Model):
    ...
    def __init__(self, exp_name, num_winners=0, num_elections="800", winners_order="positionwise_approx_cc", order="", metric="positionwise"):
        Model.__init__(self, exp_name)
        ...
        self.order = self.import_order(exp_name, num_elections, order)
