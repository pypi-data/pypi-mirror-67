...
> If you fix `README` by markdown, you can use [Online Converter](https://cloudconvert.com/md-to-rst) to format to reStructuredText (RST) and run `make check` to valid README🙂.
