...
Ext.define('SoL.view.Matches', {
    ...
    recomputeScores: function(field, newValue, oldValue) {
        ...
        for(var i = 1; ; i++) {
            var coins1 = columns[0].getComponent('coins1_' + i),
                coins2 = columns[2].getComponent('coins2_' + i),
                queen = columns[1].getComponent('queen_' + i);
        ...
        columns[0].getComponent('score1').setValue(total1);
        columns[2].getComponent('score2').setValue(total2);
    },
