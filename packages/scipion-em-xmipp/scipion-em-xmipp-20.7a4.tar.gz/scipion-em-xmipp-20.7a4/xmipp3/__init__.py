...
class Plugin(pwem.Plugin):
    ...
    def defineBinaries(cls, env):
        ...
        installVars = {'installedToken': "installation_finished",
                       ...
                       'xmippHome': cls.getHome() if cls.getHome() else '../xmipp',
        ...
        if develMode:
            print("installTgt_Dev: %s" % (installTgt + sourceTgt))
            print("bindingsTgt_Dev: %s" % bindingsAndLibsTgt)
        ...
        print("installTgt_Src: %s" % (installTgt + sourceTgt))
        print("bindingsTgt_Src: %s" % bindingsAndLibsTgt)
        ...
        print("installTgt_BinD: %s" % (installTgt + [confToken, verToken+'_Debian']))
        print("bindingsTgt_BinD: %s" % bindingsAndLibsTgt)
        ...
        print("installTgt_BinC: %s" % (installTgt + [confToken, verToken+'_Centos']))
        print("bindingsTgt_BinC: %s" % bindingsAndLibsTgt)
