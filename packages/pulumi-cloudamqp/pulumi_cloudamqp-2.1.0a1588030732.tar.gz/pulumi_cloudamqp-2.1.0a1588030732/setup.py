...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v2.1.0-alpha.1588030732+g5e6914d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v2.1.0-alpha.1588030732+g5e6914d`
                """)
            else:
                raise
