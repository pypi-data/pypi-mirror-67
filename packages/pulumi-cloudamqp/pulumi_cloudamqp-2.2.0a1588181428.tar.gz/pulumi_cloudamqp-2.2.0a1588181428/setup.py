...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'cloudamqp', 'v2.2.0-alpha.1588181428+gba1fb0d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource cloudamqp v2.2.0-alpha.1588181428+gba1fb0d`
                """)
            else:
                raise
