...
class trading_data(object):
    ...
    def GetOpenProposals(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/api.trading_data/GetOpenProposals',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            proto_dot_api_dot_trading__pb2.GetProposalsResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetProposalByID(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/api.trading_data/GetProposalByID',
            ...
            proto_dot_governance__pb2.ProposalVote.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def ObserveProposals(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/api.trading_data/ObserveProposals',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            proto_dot_governance__pb2.ProposalVote.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
