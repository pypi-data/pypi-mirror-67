...
class YOLO(object):
    ...
    def predict(self,
        ...
        If text_format is true, this method returns a cl output TODO.
        If text_format is false, this method return the input image with
        its predicted bounding boxes.
        ...
        for epoch in range(epochs):
            ...
            for elements in training_data:
                ...
                with file_writer.as_default():
                    ...
                    tf.summary.image(
                        "prediction_training", tb_prediction, step=step)
            ...
            for elements in validation_data:
                ...
                val_logits = self.model(images, training=True)
                loss = yolo_loss(
                    labels,
                    val_logits,
                    self.anchors,
                ...
                with eval_file_writer.as_default():
                    tf.summary.image(
                        "prediction_validation", tb_prediction_val, step=step)
                ...
                bboxs, cat_ids, scores = self.coco_metric_format(
                    val_logits, eff_bs, class_conf_threshold, iou_threshold,
                    False)
                # Iterate over all detections per image.
                for bbox, cat_id, score in zip(bboxs, cat_ids, scores):
                ...
                # Iterate iver all objects in labels.
                bboxs, cat_ids, scores = self.coco_metric_format(
