...
This lib contains classes and method to browse, learn from & explore sensitive
datasets.
...
class Client:
    ...
    def fit_v1(self, transform_def, keras_model_def, dataset, non_DP_training=False):
        ...
        request = requests.post(
            ...
            data=cloudpickle.dumps((transform_def, keras_model_def,
                                    dataset.id, non_DP_training)),
