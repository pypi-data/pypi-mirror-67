...
keywords = ["unsserv", "p2p", "unstructured", "membership", "network", "clustering", "bias", "aggregation", "sampling", "search",
            "dissemination", "broadcast", "pubsub"]
...
setuptools.setup(
    ...
    description="P2P out-of-the-box high-level library",
