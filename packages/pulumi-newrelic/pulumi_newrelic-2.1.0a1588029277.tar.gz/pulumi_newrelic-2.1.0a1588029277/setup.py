...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.1.0-alpha.1588029277+gbc0b186'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.1.0-alpha.1588029277+gbc0b186`
                """)
            else:
                raise
