...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.2.0-alpha.1588604513+ga0999f1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.2.0-alpha.1588604513+ga0999f1`
                """)
            else:
                raise
