...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', 'v2.1.0-alpha.1588087139+gd7d48cb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic v2.1.0-alpha.1588087139+gd7d48cb`
                """)
            else:
                raise
