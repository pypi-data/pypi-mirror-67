...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v2.1.0-alpha.1588030010+gd6b32fd'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v2.1.0-alpha.1588030010+gd6b32fd`
                """)
            else:
                raise
