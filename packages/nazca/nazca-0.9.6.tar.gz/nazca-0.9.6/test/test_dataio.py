...
class ValidXHTMLPrettyPrintTest(unittest.TestCase):
    @pytest.mark.xfail(reason="lxml seems unable to load the remote DTD")
    def test_valid(self):
    ...
    def test_prettyprint(self):
        ...
        self.assertEqual(
            html,
            (
                u'Hello <a href="http://example.com/everyone">everyone</a>, '
    ...
    def test_prettyprint_class(self):
        ...
        self.assertEqual(
            html,
            (
                u'Hello <a href="http://example.com/everyone" class="ner">everyone</a>, '
