...
class Net3Conv1MP2Lin(nn.Module):
    ...
    def __init__(self, experiment: TorchExperiment):
        ...
        # hard copying other usefull parameters
        ...
        self.convolutinal_layers = nn.Sequential(
        ...
        n_pools = count_maxpool(self.convolutinal_layers)
