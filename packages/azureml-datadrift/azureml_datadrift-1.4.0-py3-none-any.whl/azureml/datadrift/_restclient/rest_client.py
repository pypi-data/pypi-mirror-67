...
class RestClient(SDKClient):
    ...
    def get_metrics(
            self, subscription_id, resource_group_name, workspace_name, id, start_date_string=None, end_date_string=None, service_name=None, run_id=None, custom_headers=None, raw=False, **operation_config):
        """
