...
class Conversation:
    ...
    def get_current_state(self, state) -> Tuple[Type[BaseState], Any]:
        ...
        if isinstance(state, str):
            ...
            raise StateDoesNotExistError(
                "`conversation_state_getter` должна возвращать"
    ...
    def process(self,
        ...
        raw_curr_state = self.conversation_state_getter(update)
