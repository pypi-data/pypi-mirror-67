...
class TestConversation(unittest.TestCase):
    def test_method__get_state_from_state_name(self):
        ...
        conversation = Conversation(conversation_state_getter=lambda update: State3,
    ...
    def test_method__get_current_state(self):
        ...
        conversation = Conversation(conversation_state_getter=lambda update: State2,
                          states=[State1, State2, State3])
    ...
    def test_method_process(self):
        ...
        conversation = Conversation(conversation_state_getter=lambda update: TestState1,
        ...
        conversation = Conversation(conversation_state_getter=lambda update: TestState2,
                          states=[TestState1, TestState2, TestState3])
        ...
        conversation = Conversation(conversation_state_getter=lambda update: TestState3,
                          states=[TestState1, TestState2, TestState3])
        conversation.process(update='event5')
        ...
        conversation = Conversation(conversation_state_getter=lambda update: TestState4,
                          states=[TestState1, TestState2, TestState3])
        conversation.process(update='event6')
