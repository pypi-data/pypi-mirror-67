...
from src.PyHydro.hidr import hidr
import numpy as np
            ...
            for imes in range(12):
                ...
                for iusina in usinas:
                    if iusina.VolUtil > 0 and iusina.Ree == self.Codigo and iusina.StatusVolMorto[iano][imes] == 2:
                        self.EArmMax[iano][imes] = self.EArmMax[iano][imes] + iusina.RoAcum[iano][imes]*iusina.VolUtil/2.63
            ...
            for imes in range(12):
                for iusina in usinas:
                    if iusina.Ree == self.Codigo and iusina.StatusVolMorto[iano][imes] == 2:
                        if iusina.VolUtil > 0:
                            self.EC[iano,imes] = self.EC[iano,imes] + iusina.RoAcumMed[iano][imes]*iusina.QIncEntreRes(usinas, iano, imes)
                        else:
                            if iusina.StatusMotoriz[iano][imes] == 2:
                                self.EFIO[iano,imes] = self.EFIO[iano,imes] + iusina.RoEquiv[iano][imes]*iusina.QIncEntreRes(usinas, iano, imes)
