...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v1.2.0-alpha.1588443722+g9ca7df6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v1.2.0-alpha.1588443722+g9ca7df6`
                """)
