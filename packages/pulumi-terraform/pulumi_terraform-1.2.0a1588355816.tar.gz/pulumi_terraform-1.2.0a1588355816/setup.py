...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'terraform', 'v1.2.0-alpha.1588355816+g821d0f6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource terraform v1.2.0-alpha.1588355816+g821d0f6`
                """)
