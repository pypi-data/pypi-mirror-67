...
class VacBot():
    ...
    def request_all_statuses(self):
        print("THREAD STATUSES: " + str(self.thread_statuses.isAlive()))
        print("THREAD LIVE MAP: " + str(self.thread_livemap.isAlive()))
        print("THREAD COMPONENT: " + str(self.thread_components.isAlive()))
