...
class SurfingEntrance(object):
    ...
    def download_raw(self, yesterday=None):
        ...
        return raw_data_downloader.download(yesterday, yesterday)
    ...
    def update_basic(self, yesterday=None):
        ...
        return basic_data_processor.process_all(yesterday, yesterday)
    ...
    def update_derived(self, yesterday=None):
        ...
        return DerivedDataProcessor().process_all(yesterday, yesterday)
    ...
    def data_update(self):
        ...
        raw_failed_tasks = self.download_raw(yesterday)
        ...
        basic_failed_tasks = self.update_basic(yesterday)
        ...
        derived_failed_tasks = self.update_derived(yesterday)
        ...
        wechat_bot.send_data_update_status(yesterday, failed_tasks)
