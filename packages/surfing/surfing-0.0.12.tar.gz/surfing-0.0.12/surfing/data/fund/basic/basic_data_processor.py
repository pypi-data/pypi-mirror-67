...
class BasicDataProcessor(object):
    ...
    def process_all(self, start_date, end_date):
        ...
        if not self.fund_ret(start_date, end_date):
            failed_tasks.append('fund_ret')
        ...
        if not self.stock_price(start_date, end_date):
            failed_tasks.append('stock_price')
...
if __name__ == '__main__':
    ...
    # bdp.stock_price(start_date, end_date)
    bdp.fund_ret(start_date, end_date)
