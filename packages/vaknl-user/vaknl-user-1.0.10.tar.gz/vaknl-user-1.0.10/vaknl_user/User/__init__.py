...
class User(object):
    ...
    def update_statistics(self, event):
        ...
        if isinstance(event, EventDataclass.Pageview):
            ...
            giataid = event.giataid
            self.statistics['last_booked_acco'] = giataid
            self.statistics['n_bookings'] += 1
            booked_acco_counter = self.statistics['booked_acco_frequencies']
            booked_acco_counter[giataid] = booked_acco_counter[giataid] + 1 if giataid in booked_acco_counter else 1
            self.statistics['booked_acco_frequencies'] = booked_acco_counter
