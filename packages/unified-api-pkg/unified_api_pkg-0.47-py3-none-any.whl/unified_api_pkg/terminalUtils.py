...
def formatTransReceiptTerminal(transData,printOut,props):
    if transData["TYPE"] == "EDC" or transData["TYPE"] == "UPI" or transData["TYPE"] == "VAC":
        ...
        if (transData["TYPE"] != "EDC" or transData["TYPE"] != "MEMBER"):
            ...
            mix_1_column(bilingualDict["MID"],"MID",transData["MERCHANTID"],prop["language"],printOut)
            mix_1_column(bilingualDict["TID"],"TID",transData["TERMINALID"],prop["language"],printOut)
            mix_1_column(bilingualDict["PAN"],"PAN",transData["PAN"] + " " + transData["ENTRYMODE"],prop["language"],printOut)
            mix_1_column(bilingualDict["EXPDATE"],"EXPDATE",transData["EXPDATE"][0:2] + "/"+ transData["EXPDATE"][2:4],prop["language"],printOut)
            printOut.append(transData["CARD"][2:])
            mix_1_column(bilingualDict["APPCODE"],"APPCODE",transData["APPCODE"],prop["language"],printOut)
            mix_1_column(bilingualDict["REFNUM"],"REFNUM",transData["REFNUM"],prop["language"],printOut)
            ...
            if "LOYALTY" in transData:
                ...
                mix_1_column(bilingualDict["TOTAL"],"TOTAL",props["region"]+" "+__add_minus(transData["CMD"])+'%.2f' % transData["AMT"],prop["language"],printOut)
                ...
                mix_1_column(bilingualDict["NET"],"NET",props["region"]+" "+__add_minus(transData["CMD"])+'%.2f' % transData["NETAMT"],prop["language"],printOut)
        ...
        if transData["RESP"] == "000":
            ...
            mix_1_column(bilingualDict["MID"],"MID",transData["MERCHANTID"],prop["language"],printOut)
            mix_1_column(bilingualDict["TID"],"TID",transData["TERMINALID"],prop["language"],printOut)
            mix_1_column(bilingualDict["PAN"],"PAN",transData["PAN"],prop["language"],printOut)
