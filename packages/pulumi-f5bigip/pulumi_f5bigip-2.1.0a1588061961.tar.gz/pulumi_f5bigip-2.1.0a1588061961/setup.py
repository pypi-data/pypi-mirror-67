...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'f5bigip', 'v2.1.0-alpha.1588061961+g046809a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource f5bigip v2.1.0-alpha.1588061961+g046809a`
                """)
            else:
                raise
