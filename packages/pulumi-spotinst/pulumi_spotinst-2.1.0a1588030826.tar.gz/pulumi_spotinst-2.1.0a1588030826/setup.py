...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.1.0-alpha.1588030826+g9b54a5f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.1.0-alpha.1588030826+g9b54a5f`
                """)
            else:
                raise
