...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', 'v2.2.0-alpha.1588882134+g6fc715f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst v2.2.0-alpha.1588882134+g6fc715f`
                """)
            else:
                raise
