...
class VerificationPolicyParameters(Model):
    ...
    :type version: str
    :param attributes:
    :type attributes: list[~agency.models.VerificationPolicyAttributeContract]
    :param predicates:
    :type predicates: list[~agency.models.VerificationPolicyPredicateContract]
    :param revocation_requirement:
    :type revocation_requirement:
     ~agency.models.VerificationPolicyRevocationReqirement
    """
