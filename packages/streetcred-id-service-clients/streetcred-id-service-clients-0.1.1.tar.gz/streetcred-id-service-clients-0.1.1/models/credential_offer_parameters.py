...
class CredentialOfferParameters(Model):
    ...
    :param definition_id: Required. Gets or sets the credential definition
     identifier.
    ...
    :param automatic_issuance: If true, the credential will automatically be
     issued once the individual accepts the offer. If
     false, when an individual accepts the offer the credential will be in
     state 'Requested' and must be manually issued using the
