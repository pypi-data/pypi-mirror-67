...
class AttributeFilter(Model):
    ...
    def __init__(self, *, schema_id: str=None, schema_issuer_did: str=None, schema_name: str=None, schema_version: str=None, issuer_did: str=None, credential_definition_id: str=None, **kwargs) -> None:
