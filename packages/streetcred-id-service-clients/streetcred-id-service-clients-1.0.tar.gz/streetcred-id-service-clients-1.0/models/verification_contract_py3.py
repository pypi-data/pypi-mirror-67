...
class VerificationContract(Model):
    ...
    :param policy:
    :type policy: ~agency.models.VerificationPolicyParameters
    ...
    def __init__(self, *, connection_id: str=None, verification_id: str=None, definition_id: str=None, state=None, created_at_utc=None, updated_at_utc=None, is_valid: bool=None, verified_at_utc=None, proof=None, policy=None, verification_request_data: str=None, verification_request_url: str=None, **kwargs) -> None:
