...
print("Package to control the 3d printed raspberry pi powered evolution contraption")
...
class Experiment:
    ...
    def plot(self, tubes=None):
        ...
        for tube in tubes:
            plot_tube(self, tube, log_OD=log_OD, log_pumps=log_pumps)
