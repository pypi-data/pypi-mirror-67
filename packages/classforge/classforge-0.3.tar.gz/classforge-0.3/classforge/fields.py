...
class Field(object):
    ...
    def __init__(self, name=None, type=None, default=None, nullable=True, mutable=True, mutator=None, accessor=None, choices=None, required=False, hidden=False, remap=None):
    ...
    def copy(self):
        obj = Field(type=self.type, default=self.default, nullable=self.nullable, mutable=self.mutable, mutator=self.mutator, accessor=self.accessor, choices=self.choices, required=self.required, remap=self.remap, hidden=self.hidden)
        obj._mutated = False
