...
class connect_Flow(connect_Base):
    ...
    def logStepData(self,level,request,data,lastRequest,lastData):
        ...
        while handler.hasNext():
            ...
            connect_Env.getLogger()._writeToHandler(level,handler1.formatter.formatList(_hx_list),handler1)
...
class connect_api_impl_ApiClientImpl(connect_Base):
    ...
    def logRequest(level,method,url,headers,body,response):
        ...
        while handler.hasNext():
            ...
            connect_Env.getLogger()._writeToHandler(level,fmt.formatBlock((("" + ("null" if firstMessage is None else firstMessage)) + HxOverrides.stringOrNull(fmt.formatList(requestList)))),handler1)
...
class connect_logger_Logger(connect_Base):
    ...
    _hx_methods = ["getPath", "getLevel", "setFilename", "getFilename", "getHandlers", "openSection", "closeSection", "writeBlock", "writeCodeBlock", "writeList", "writeTable", "write", "getMaskedFields", "log", "debug", "info", "notice", "warning", "error", "critical", "alert", "emergency", "_writeToHandler", "writeSections"]
...
class connect_logger_LoggerConfig(connect_Base):
    ...
    _hx_methods = ["path", "level", "levelName", "handlers", "maskedFields"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_Base
