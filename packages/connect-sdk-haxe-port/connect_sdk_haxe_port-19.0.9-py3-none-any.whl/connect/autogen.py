...
class connect_logger_Logger(connect_Base):
    ...
    __slots__ = ("path", "level", "handlers", "sections", "maskedFields", "compact")
    _hx_fields = ["path", "level", "handlers", "sections", "maskedFields", "compact"]
    _hx_methods = ["getPath", "getLevel", "isCompact", "setFilename", "getFilename", "getHandlers", "openSection", "closeSection", "writeBlock", "writeCodeBlock", "writeList", "writeTable", "write", "getMaskedFields", "log", "debug", "info", "notice", "warning", "error", "critical", "alert", "emergency", "_writeToHandler", "writeSections"]
...
class connect_logger_LoggerConfig(connect_Base):
    ...
    __slots__ = ("path_", "level_", "handlers_", "maskedFields_", "compact_", "levelTranslation")
    _hx_fields = ["path_", "level_", "handlers_", "maskedFields_", "compact_", "levelTranslation"]
    _hx_methods = ["path", "level", "levelName", "handlers", "maskedFields", "compact"]
    _hx_statics = []
    _hx_interfaces = []
    _hx_super = connect_Base
