...
class Props():
    def __init__(self, *, setup: typing.List["Item"], table: aws_cdk.aws_dynamodb.Table, refresh_on_update: typing.Optional[bool]=None, teardown: typing.Optional[typing.List["ItemKey"]]=None) -> None:
        """
        :param setup: 
        :param table: 
