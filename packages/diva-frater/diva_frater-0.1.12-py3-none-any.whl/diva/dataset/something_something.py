...
something_something = Dataset('something_something', [
    ...
    'Plugging something into something but pulling it right out as you remove '
    'your hand',
    ...
    'Putting something on the edge of something so it is not supported and falls '
    'down',
    "Putting something onto a slanted surface but it doesn't glide down",
    'Putting something onto something',
    'Putting something onto something else that cannot support it so it falls '
    'down',
    ...
    "Putting something that can't roll onto a slanted surface, so it stays where "
    'it is',
    'Putting something that cannot actually stand upright upright on the table, '
    'so it falls on its side',
