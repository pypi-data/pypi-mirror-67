...
class CriteriaController(Plugin, PluginInterface):
    ...
    def __init__(self, calculation_procedure_def_file, object_def_file, data_source, user_function=None, volume_def_file=None):
        '''
        ...
        Plugin.__init__(self, path_to_def_file=calculation_procedure_def_file, path_def_file_id=object_def_file,
                        data_source=data_source, volume_path=volume_def_file, user_function=user_function,
