...
class ConfigMapService(BaseService):
    ...
    @transaction
    @check_required(['config_map_id', 'domain_id'])
    ...
    def delete(self, params):
        ...
        self.config_map_mgr.delete_config_map(params['config_map_id'], params['domain_id'])
    ...
    def get(self, params):
        ...
        return self.config_map_mgr.get_config_map(params['config_map_id'], params['domain_id'], params.get('only'))

    @transaction
    @check_required(['domain_id'])
    @append_query_filter(['config_map_id', 'name', 'domain_id'])
    @append_keyword_filter(['config_map_id', 'name'])
