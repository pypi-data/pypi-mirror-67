...
install_requires = ['numpy', 'scipy', 'dendropy', 'biopython']
...
setuptools.setup(
    ...
    description="MetaPhlAn: Metagenomic Phylogenetic Analysis, v3",
    long_description='MetaPhlAn is a computational tool for profiling the composition of microbial communities (Bacteria, Archaea and Eukaryotes) from metagenomic shotgun sequencing data (i.e. not 16S) with species-level. With the newly added StrainPhlAn module, it is now possible to perform accurate strain-level microbial profiling.',
