...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_codepipeline_actions._jsii": [
            "aws-codepipeline-actions@1.36.0.jsii.tgz"
        ],
        "aws_cdk.aws_codepipeline_actions": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codebuild==1.36.0",
        "aws-cdk.aws-codecommit==1.36.0",
        "aws-cdk.aws-codedeploy==1.36.0",
        "aws-cdk.aws-codepipeline==1.36.0",
        "aws-cdk.aws-ec2==1.36.0",
        "aws-cdk.aws-ecr==1.36.0",
        "aws-cdk.aws-ecs==1.36.0",
        "aws-cdk.aws-events==1.36.0",
        "aws-cdk.aws-events-targets==1.36.0",
