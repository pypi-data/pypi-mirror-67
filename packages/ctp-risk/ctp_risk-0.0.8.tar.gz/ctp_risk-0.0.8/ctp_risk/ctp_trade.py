...
class Trade(object):
    ...
    def ReqQryInvestorMarginRate(self, BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', HedgeFlag: chr = list(chr)[0]):
    ...
    def ReqQryOrderStat(self, BrokerID: str = '', ExchangeProductInstID: str = '', SortType: chr = list(chr)[0], ResultCount: int = 1, ResultRatio: float = .0):
    ...
    def ReqQryInstPositionRate(self, BrokerID: str = '', InstIDStart: str = '', InstIDEnd: str = '', hbtotal_little: float = .0, hbtotal_medium: float = .0, hstotal_little: float = .0, hstotal_medium: float = .0, htotal_little: float = .0, htotal_medium: float = .0, sbtotal_little: float = .0, sbtotal_medium: float = .0, sstotal_little: float = .0, sstotal_medium: float = .0, stotal_little: float = .0, stotal_medium: float = .0, buytotal_little: float = .0, buytotal_medium: float = .0, selltotal_little: float = .0, selltotal_medium: float = .0, total_little: float = .0, total_medium: float = .0, ValueMode: chr = list(chr)[0], QryInstPositionRateCnt: int = 1):
    ...
    def ReqQryProductPositionRate(self, BrokerID: str = '', ProductID: str = '', hbtotal_little: float = .0, hbtotal_medium: float = .0, hstotal_little: float = .0, hstotal_medium: float = .0, htotal_little: float = .0, htotal_medium: float = .0, sbtotal_little: float = .0, sbtotal_medium: float = .0, sstotal_little: float = .0, sstotal_medium: float = .0, stotal_little: float = .0, stotal_medium: float = .0, buytotal_little: float = .0, buytotal_medium: float = .0, selltotal_little: float = .0, selltotal_medium: float = .0, total_little: float = .0, total_medium: float = .0, ValueMode: chr = list(chr)[0]):
    ...
    def ReqRiskOrderInsert(self, FCType: chr = list(chr)[0], Time1: str = '', Millisec1: int = 1, Time2: str = '', Millisec2: int = 1, FCSceneId: str = '', BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', OrderRef: str = '', UserID: str = '', OrderPriceType: chr = list(chr)[0], Direction: chr = list(chr)[0], CombOffsetFlag: str = '', CombHedgeFlag: str = '', LimitPrice: float = .0, VolumeTotalOriginal: int = 1, TimeCondition: chr = list(chr)[0], GTDDate: str = '', VolumeCondition: chr = list(chr)[0], MinVolume: int = 1, ContingentCondition: chr = list(chr)[0], StopPrice: float = .0, ForceCloseReason: chr = list(chr)[0], IsAutoSuspend: int = 1, BusinessUnit: str = '', RequestID: int = 1, UserForceClose: int = 1, FrontID: int = 1, SessionID: int = 1, IsSwapOrder: int = 1, ExchangeID: str = '', InvestUnitID: str = '', AccountID: str = '', CurrencyID: str = '', ClientID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqRiskOrderAction(self, BrokerID: str = '', InvestorID: str = '', OrderActionRef: int = 1, OrderRef: str = '', RequestID: int = 1, FrontID: int = 1, SessionID: int = 1, ExchangeID: str = '', OrderSysID: str = '', ActionFlag: chr = list(chr)[0], LimitPrice: float = .0, VolumeChange: int = 1, UserID: str = '', InstrumentID: str = '', InvestUnitID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqRiskNotifyCommand(self, BrokerID: str = '', UserID: str = '', NotifyClass: chr = list(chr)[0], InvestorID: str = '', IsAutoSystem: int = 1, IsAutoSMS: int = 1, IsAutoEmail: int = 1, Reserve: str = '', Pattern: str = '', IsNormal: int = 1, IsWarn: int = 1, CurrencyID: str = ''):
    ...
    def ReqBatchForceCloseCalc(self, ForceCloseLevel: chr = list(chr)[0], ForceCloseRelease: chr = list(chr)[0], FCNonLimitFirst: int = 1, FCPosiProfitLossFirst: int = 1, FCCustomAmount: float = .0, FCCustomRiskLevel: float = .0, ProductInstrumentID: str = '', FCPosiDirection: chr = list(chr)[0], FCHedgeFlag: chr = list(chr)[0], FCCombPosiFlag: chr = list(chr)[0], FCHistoryPosiOrder: chr = list(chr)[0], FCPrice: chr = list(chr)[0], PriceTick: int = 1, FCRulePriority: str = '', ForceClosePositionRuleCnt: int = 1, BrokerID: str = '', InvestorID: str = '', ForceCloseListCnt: int = 1):
    ...
    def ReqForceCloseCalc(self, ForceCloseLevel: chr = list(chr)[0], ForceCloseRelease: chr = list(chr)[0], FCNonLimitFirst: int = 1, FCPosiProfitLossFirst: int = 1, FCCustomAmount: float = .0, FCCustomRiskLevel: float = .0, InstrumentID: str = '', BrokerID: str = '', InvestorID: str = '', PosiDirection: chr = list(chr)[0], HedgeFlag: chr = list(chr)[0], PositionDate: chr = list(chr)[0], Position: int = 1, FCPosition: int = 1, FCPriceType: chr = list(chr)[0], PriceTick: int = 1, FCPrice: float = .0, ReleaseMargin: float = .0, CloseProfit: float = .0, ExchReleaseMargin: float = .0, PosiProfit: float = .0, CashIn: float = .0, OptionValue: float = .0, ForceClosePositionCnt: int = 1):
        pForceCloseStandard = CShfeFtdcForceCloseStandardField()
        pForceCloseStandard.ForceCloseLevel = ForceCloseLevel.value
        pForceCloseStandard.ForceCloseRelease = ForceCloseRelease.value
        pForceCloseStandard.FCNonLimitFirst = FCNonLimitFirst
    ...
    def ReqQryPriceVaryEffect(self, BrokerID: str = '', InvestorID: str = '', RiskLevel: chr = list(chr)[0]):
    ...
    def ReqQrySafePriceRange(self, PriceVaryAlgo: chr = list(chr)[0], RiskLevel: chr = list(chr)[0], MaxLimitDay: int = 1, InstrumentID: str = '', Direction: chr = list(chr)[0], Pecent: float = .0, BasePriceType: chr = list(chr)[0], BasePrice: float = .0, PriceVaryParamCnt: int = 1, BrokerID: str = '', InvestorID: str = '', CurrencyID: str = '', BrokerInvestorCurrencyCnt: int = 1):
    ...
    def ReqRiskParkedOrderInsert(self, ParkedOrderID: str = '', LocalID: str = '', UserType: chr = list(chr)[0], Status: chr = list(chr)[0], StatusMsg: str = '', TriggerType: chr = list(chr)[0], TradeSegment: int = 1, ExchangeID: str = '', FCType: chr = list(chr)[0], Time1: str = '', Millisec1: int = 1, Time2: str = '', Millisec2: int = 1, FCSceneId: str = '', BrokerID: str = '', InvestorID: str = '', InstrumentID: str = '', OrderRef: str = '', UserID: str = '', OrderPriceType: chr = list(chr)[0], Direction: chr = list(chr)[0], CombOffsetFlag: str = '', CombHedgeFlag: str = '', LimitPrice: float = .0, VolumeTotalOriginal: int = 1, TimeCondition: chr = list(chr)[0], GTDDate: str = '', VolumeCondition: chr = list(chr)[0], MinVolume: int = 1, ContingentCondition: chr = list(chr)[0], StopPrice: float = .0, ForceCloseReason: chr = list(chr)[0], IsAutoSuspend: int = 1, BusinessUnit: str = '', RequestID: int = 1, UserForceClose: int = 1, OrderSubmitStatus: chr = list(chr)[0], OrderStatus: chr = list(chr)[0], OrderStatusMsg: str = '', ErrorID: int = 1, ErrorMsg: str = '', ParkedTime: str = '', OriginalParkedVol: int = 1, MaxCloseVol1: int = 1, MaxCloseVol2: int = 1, Call1: float = .0, Call2: float = .0, MoneyIO1: float = .0, MoneyIO2: float = .0, DeleteReason: str = '', ForceCloseRelease: chr = list(chr)[0], IsSwapOrder: int = 1, InvestUnitID: str = '', AccountID: str = '', CurrencyID: str = '', ClientID: str = '', IPAddress: str = '', MacAddress: str = ''):
    ...
    def ReqAddRiskUserEvent(self, SequenceNo: int = 1, EventDate: str = '', EventTime: str = '', BrokerID: str = '', UserID: str = '', EventType: chr = list(chr)[0], EventInfo: str = '', TradingDay: str = ''):
    ...
    def ReqModNoticePattern(self, BrokerID: str = '', BizType: str = '', Method: chr = list(chr)[0], BizName: str = '', UserID: str = '', IsActive: int = 1, Pattern: str = ''):
    ...
    def ReqAddRiskNotifyA(self, SequenceNo: int = 1, EventDate: str = '', EventTime: str = '', BrokerID: str = '', UserID: str = '', InvestorID: str = '', NotifyClass: chr = list(chr)[0], NotifyMethod: chr = list(chr)[0], NotifyStatus: chr = list(chr)[0], Message: str = '', Reserve: str = '', CurrencyID: str = ''):
    ...
    def ReqAddBizNotice(self, TradingDay: str = '', SequenceNo: int = 1, Method: chr = list(chr)[0], EventTime: str = '', BrokerID: str = '', UserID: str = '', InvestorID: str = '', BizType: str = '', Status: chr = list(chr)[0], Message: str = '', ErrorMsg: str = ''):
    ...
    def ReqAddInvestorPattern(self, BrokerID: str = '', InvestorID: str = '', BizType: str = '', Method: chr = list(chr)[0], PatternID: int = 1, IsActive: int = 1, InvestorPatternCnt: int = 1):
    ...
    def ReqModInvestorPattern(self, BrokerID: str = '', InvestorID: str = '', BizType: str = '', Method: chr = list(chr)[0], PatternID: int = 1, IsActive: int = 1, InvestorPatternCnt: int = 1):
        pInvestorPattern = CShfeFtdcInvestorPatternField()
        pInvestorPattern.BrokerID = bytes(BrokerID, encoding='ascii')
        pInvestorPattern.InvestorID = bytes(InvestorID, encoding='ascii')
        pInvestorPattern.BizType = bytes(BizType, encoding='ascii')
    ...
    def ReqRemInvestorPattern(self, BrokerID: str = '', InvestorID: str = '', BizType: str = '', Method: chr = list(chr)[0], PatternID: int = 1, IsActive: int = 1, InvestorPatternCnt: int = 1):
        pInvestorPattern = CShfeFtdcInvestorPatternField()
        pInvestorPattern.BrokerID = bytes(BrokerID, encoding='ascii')
        pInvestorPattern.InvestorID = bytes(InvestorID, encoding='ascii')
        pInvestorPattern.BizType = bytes(BizType, encoding='ascii')
    ...
    def ReqQryPositionStat(self, BrokerID: str = '', ExchangeProductInstID: str = '', SortType: chr = list(chr)[0], ResultCount: int = 1, ResultRatio: float = .0):
        pQryStat = CShfeFtdcQryStatField()
        pQryStat.BrokerID = bytes(BrokerID, encoding='ascii')
        pQryStat.ExchangeProductInstID = bytes(ExchangeProductInstID, encoding='ascii')
        pQryStat.SortType = SortType.value
    ...
    def ReqQryTradeStat(self, BrokerID: str = '', ExchangeProductInstID: str = '', SortType: chr = list(chr)[0], ResultCount: int = 1, ResultRatio: float = .0):
        pQryStat = CShfeFtdcQryStatField()
        pQryStat.BrokerID = bytes(BrokerID, encoding='ascii')
        pQryStat.ExchangeProductInstID = bytes(ExchangeProductInstID, encoding='ascii')
        pQryStat.SortType = SortType.value
    ...
    def ReqQryStressTest(self, BrokerID: str = '', InvestorRange: chr = list(chr)[0], InvestorID: str = '', InstrumentID: str = '', PriceType: chr = list(chr)[0], Price: float = .0, STPriceCnt: int = 1, HedgeFlag: chr = list(chr)[0], LongMarginRatioByMoney: float = .0, LongMarginRatioByVolume: float = .0, ShortMarginRatioByMoney: float = .0, ShortMarginRatioByVolume: float = .0, MinMargin: float = .0, STMarginRateCnt: int = 1, STExchMarginRateCnt: int = 1, STDCECombMarginUsed: int = 1, STDCECombType: chr = list(chr)[0], SequenceNo: int = 1, ProductID: str = '', ProductID2: str = '', STDCECombMarginParamCnt: int = 1, STDCESPInsGroupParamCnt: int = 1):
    ...
    def ReqSetSmsStatus(self, SequenceNo: int = 1, Type: chr = list(chr)[0], BrokerID: str = '', UserID: str = '', InvestorID: str = '', Status: chr = list(chr)[0]):
    ...
    def ReqQryExchMarginRate(self, BrokerID: str = '', InstrumentID: str = '', HedgeFlag: chr = list(chr)[0]):
    ...
    def ReqQryExeciseTest(self, BrokerID: str = '', InvestorRange: chr = list(chr)[0], InvestorID: str = '', InstrumentID: str = '', PriceType: chr = list(chr)[0], Price: float = .0, ETPriceCnt: int = 1, PosiDirection: chr = list(chr)[0], HedgeFlag: chr = list(chr)[0], PositionDate: chr = list(chr)[0], Position: int = 1, EXEPosition: int = 1, EXEPriceType: chr = list(chr)[0], EXEPrice: float = .0, ETStrikePositionCnt: int = 1, STDCECombType: chr = list(chr)[0], SequenceNo: int = 1, ProductID: str = '', ProductID2: str = '', ETDCECombMarginParamCnt: int = 1, ETDCESPInsGroupParamCnt: int = 1):
