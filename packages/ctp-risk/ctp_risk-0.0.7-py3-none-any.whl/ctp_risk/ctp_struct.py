...
class  CShfeFtdcTransferBankToFutureReqField(Structure):
    ...
    def getFuturePwdFlag(self):
        '''密码标志'''
        return chr(ord(self.FuturePwdFlag))
...
class  CShfeFtdcExchangeField(Structure):
    ...
    def getExchangeProperty(self):
        '''交易所属性'''
        return chr(ord(self.ExchangeProperty))
...
class  CShfeFtdcProductField(Structure):
    ...
    def getProductClass(self):
        '''产品类型'''
        return chr(ord(self.ProductClass))
    ...
    def getPositionType(self):
        '''持仓类型'''
        return chr(ord(self.PositionType))

    def getPositionDateType(self):
        '''持仓日期类型'''
        return chr(ord(self.PositionDateType))

    def getCloseDealType(self):
        '''平仓处理类型'''
        return chr(ord(self.CloseDealType))
    ...
    def getMortgageFundUseRange(self):
        '''质押资金可用范围'''
        return chr(ord(self.MortgageFundUseRange))
...
class  CShfeFtdcInstrumentField(Structure):
    ...
    def getInstLifePhase(self):
        '''合约生命周期状态'''
        return chr(ord(self.InstLifePhase))
    ...
    def getLongMarginRatio(self):
        '''多头保证金率'''
        self.LongMarginRatio

    def getShortMarginRatio(self):
        '''空头保证金率'''
        self.ShortMarginRatio

    def getMaxMarginSideAlgorithm(self):
        '''是否使用大额单边保证金算法'''
        return chr(ord(self.MaxMarginSideAlgorithm))
    ...
    def getOptionsType(self):
        '''期权类型'''
        return chr(ord(self.OptionsType))
    ...
    def getCombinationType(self):
        '''组合类型'''
        return chr(ord(self.CombinationType))
...
class  CShfeFtdcInvestorField(Structure):
    ...
    def getIdentifiedCardType(self):
        '''证件类型'''
        return chr(ord(self.IdentifiedCardType))
...
class  CShfeFtdcTradingCodeField(Structure):
    ...
    def getClientIDType(self):
        '''交易编码类型'''
        return chr(ord(self.ClientIDType))
...
class  CShfeFtdcSuperUserFunctionField(Structure):
    ...
    def getFunctionCode(self):
        '''功能代码'''
        return chr(ord(self.FunctionCode))
...
class  CShfeFtdcTradingAccountField(Structure):
    ...
    def getPreFundMortgageIn(self):
        '''上次货币质入金额'''
        self.PreFundMortgageIn

    def getPreFundMortgageOut(self):
        '''上次货币质出金额'''
        self.PreFundMortgageOut
    ...
    def getFundMortgageOut(self):
        '''货币质出金额'''
        self.FundMortgageOut

    def getFundMortgageAvailable(self):
        '''货币质押余额'''
        self.FundMortgageAvailable
    ...
    def getSpecProductMargin(self):
        '''特殊产品占用保证金'''
        self.SpecProductMargin

    def getSpecProductFrozenMargin(self):
        '''特殊产品冻结保证金'''
        self.SpecProductFrozenMargin

    def getSpecProductCommission(self):
        '''特殊产品手续费'''
        self.SpecProductCommission
    ...
    def getSpecProductPositionProfit(self):
        '''特殊产品持仓盈亏'''
        self.SpecProductPositionProfit

    def getSpecProductCloseProfit(self):
        '''特殊产品平仓盈亏'''
        self.SpecProductCloseProfit
    ...
    def getSpecProductExchangeMargin(self):
        '''特殊产品交易所保证金'''
        self.SpecProductExchangeMargin
...
class  CShfeFtdcInvestorPositionField(Structure):
    ...
    def getPosiDirection(self):
        '''持仓多空方向'''
        return chr(ord(self.PosiDirection))

    def getHedgeFlag(self):
        '''投机套保标志'''
        return chr(ord(self.HedgeFlag))

    def getPositionDate(self):
        '''持仓日期'''
        return chr(ord(self.PositionDate))
    ...
    def getLongFrozenAmount(self):
        '''开仓冻结金额'''
        self.LongFrozenAmount

    def getShortFrozenAmount(self):
        '''开仓冻结金额'''
        self.ShortFrozenAmount
    ...
    def getCombShortFrozen(self):
        '''组合空头冻结'''
        self.CombShortFrozen

    def getCloseProfitByDate(self):
        '''逐日盯市平仓盈亏'''
        self.CloseProfitByDate

    def getCloseProfitByTrade(self):
        '''逐笔对冲平仓盈亏'''
        self.CloseProfitByTrade
    ...
    def getMarginRateByMoney(self):
        '''保证金率'''
        self.MarginRateByMoney

    def getMarginRateByVolume(self):
        '''保证金率(按手数)'''
        self.MarginRateByVolume
...
class  CShfeFtdcInstrumentMarginRateField(Structure):
    ...
    def getInvestorRange(self):
        '''投资者范围'''
        return chr(ord(self.InvestorRange))
...
class  CShfeFtdcInstrumentTradingRightField(Structure):
    ...
    def getTradingRight(self):
        '''交易权限'''
        return chr(ord(self.TradingRight))
...
class  CShfeFtdcBrokerUserFunctionField(Structure):
    ...
    def getBrokerFunctionCode(self):
        '''经纪公司功能代码'''
        return chr(ord(self.BrokerFunctionCode))
...
class  CShfeFtdcTraderOfferField(Structure):
    ...
    def getTraderConnectStatus(self):
        '''交易所交易员连接状态'''
        return chr(ord(self.TraderConnectStatus))
...
class  CShfeFtdcInputOrderField(Structure):
    ...
    def getOrderPriceType(self):
        '''报单价格条件'''
        return chr(ord(self.OrderPriceType))

    def getDirection(self):
        '''买卖方向'''
        return chr(ord(self.Direction))
    ...
    def getTimeCondition(self):
        '''有效期类型'''
        return chr(ord(self.TimeCondition))
    ...
    def getVolumeCondition(self):
        '''成交量类型'''
        return chr(ord(self.VolumeCondition))
    ...
    def getContingentCondition(self):
        '''触发条件'''
        return chr(ord(self.ContingentCondition))
    ...
    def getForceCloseReason(self):
        '''强平原因'''
        return chr(ord(self.ForceCloseReason))
...
class  CShfeFtdcOrderField(Structure):
    ...
    def getOrderSubmitStatus(self):
        '''报单提交状态'''
        return chr(ord(self.OrderSubmitStatus))
    ...
    def getOrderSource(self):
        '''报单来源'''
        return chr(ord(self.OrderSource))

    def getOrderStatus(self):
        '''报单状态'''
        return chr(ord(self.OrderStatus))

    def getOrderType(self):
        '''报单类型'''
        return chr(ord(self.OrderType))
...
class  CShfeFtdcInputOrderActionField(Structure):
    ...
    def getActionFlag(self):
        '''操作标志'''
        return chr(ord(self.ActionFlag))
...
class  CShfeFtdcOrderActionField(Structure):
    ...
    def getOrderActionStatus(self):
        '''报单操作状态'''
        return chr(ord(self.OrderActionStatus))
...
class  CShfeFtdcExchangeTradeField(Structure):
    ...
    def getTradingRole(self):
        '''交易角色'''
        return chr(ord(self.TradingRole))
    ...
    def getOffsetFlag(self):
        '''开平标志'''
        return chr(ord(self.OffsetFlag))
    ...
    def getTradeType(self):
        '''成交类型'''
        return chr(ord(self.TradeType))

    def getPriceSource(self):
        '''成交价来源'''
        return chr(ord(self.PriceSource))
    ...
    def getTradeSource(self):
        '''成交来源'''
        return chr(ord(self.TradeSource))
...
class  CShfeFtdcInstrumentStatusField(Structure):
    ...
    def getInstrumentStatus(self):
        '''合约交易状态'''
        return chr(ord(self.InstrumentStatus))
    ...
    def getEnterReason(self):
        '''进入本状态原因'''
        return chr(ord(self.EnterReason))
...
class  CShfeFtdcInvestorPositionDetailField(Structure):
    ...
    def getPositionProfitByDate(self):
        '''逐日盯市持仓盈亏'''
        self.PositionProfitByDate

    def getPositionProfitByTrade(self):
        '''逐笔对冲持仓盈亏'''
        self.PositionProfitByTrade
...
class  CShfeFtdcUserRightField(Structure):
    ...
    def getUserRightType(self):
        '''客户权限类型'''
        return chr(ord(self.UserRightType))
...
class  CShfeFtdcBrokerWithdrawAlgorithmField(Structure):
    ...
    def getWithdrawAlgorithm(self):
        '''可提资金算法'''
        return chr(ord(self.WithdrawAlgorithm))
    ...
    def getIncludeCloseProfit(self):
        '''可提是否包含平仓盈利'''
        return chr(ord(self.IncludeCloseProfit))

    def getAllWithoutTrade(self):
        '''本日无仓且无成交客户是否受可提比例限制'''
        return chr(ord(self.AllWithoutTrade))

    def getAvailIncludeCloseProfit(self):
        '''可用是否包含平仓盈利'''
        return chr(ord(self.AvailIncludeCloseProfit))

    def getIsBrokerUserEvent(self):
        '''是否启用用户事件'''
        self.IsBrokerUserEvent
    ...
    def getFundMortgageRatio(self):
        '''货币质押比率'''
        self.FundMortgageRatio

    def getBalanceAlgorithm(self):
        '''权益算法'''
        return chr(ord(self.BalanceAlgorithm))
...
class  CShfeFtdcSyncStatusField(Structure):
    ...
    def getDataSyncStatus(self):
        '''数据同步状态'''
        return chr(ord(self.DataSyncStatus))
...
class  CShfeFtdcLinkManField(Structure):
    ...
    def getPersonType(self):
        '''联系人类型'''
        return chr(ord(self.PersonType))
...
class  CShfeFtdcQryBrokerUserEventField(Structure):
    ...
    def getUserEventType(self):
        '''用户事件类型'''
        return chr(ord(self.UserEventType))
...
class  CShfeFtdcInvestorSumInfoField(Structure):
    ...
    def getmd5_1(self):
        '''MD5校验码1'''
        return chr(ord(self.md5_1))

    def getmd5_2(self):
        '''MD5校验码2'''
        return chr(ord(self.md5_2))

    def getmd5_3(self):
        '''MD5校验码3'''
        return chr(ord(self.md5_3))

    def getmd5_4(self):
        '''MD5校验码4'''
        return chr(ord(self.md5_4))

    def getmd5_5(self):
        '''MD5校验码5'''
        return chr(ord(self.md5_5))

    def getmd5_6(self):
        '''MD5校验码6'''
        return chr(ord(self.md5_6))

    def getmd5_7(self):
        '''MD5校验码7'''
        return chr(ord(self.md5_7))

    def getmd5_8(self):
        '''MD5校验码8'''
        return chr(ord(self.md5_8))

    def getmd5_9(self):
        '''MD5校验码9'''
        return chr(ord(self.md5_9))

    def getmd5_10(self):
        '''MD5校验码10'''
        return chr(ord(self.md5_10))

    def getmd5_11(self):
        '''MD5校验码11'''
        return chr(ord(self.md5_11))

    def getmd5_12(self):
        '''MD5校验码12'''
        return chr(ord(self.md5_12))

    def getmd5_13(self):
        '''MD5校验码13'''
        return chr(ord(self.md5_13))

    def getmd5_14(self):
        '''MD5校验码14'''
        return chr(ord(self.md5_14))

    def getmd5_15(self):
        '''MD5校验码15'''
        return chr(ord(self.md5_15))

    def getmd5_16(self):
        '''MD5校验码16'''
        return chr(ord(self.md5_16))
...
class  CShfeFtdcInvestorRiskAccountField(Structure):
    ...
    def getPreSpecProductMargin(self):
        '''上次特殊产品占用交易所保证金'''
        self.PreSpecProductMargin

    def getPreSpecProductExchangeMargin(self):
        '''上次特殊产品占用保证金'''
        self.PreSpecProductExchangeMargin

    def getPreMarginOnMortgage(self):
        '''上一交易日算在质押上的保证金'''
        self.PreMarginOnMortgage

    def getPreExchMarginOnMortgage(self):
        '''上一交易日算在质押上的交易所保证金'''
        self.PreExchMarginOnMortgage
    ...
    def getMaintCurrMargin(self):
        '''维持保证金总额'''
        self.MaintCurrMargin

    def getMaintExchangeMargin(self):
        '''交易所维持保证金'''
        self.MaintExchangeMargin
...
class  CShfeFtdcInvestorLinkManField(Structure):
    ...
    def getOrderManIdentifiedCardType(self):
        '''指定下单人证件类型'''
        return chr(ord(self.OrderManIdentifiedCardType))
    ...
    def getFundManIdentifiedCardType(self):
        '''资金调拨人证件类型'''
        return chr(ord(self.FundManIdentifiedCardType))
    ...
    def getOpenManIdentifiedCardType(self):
        '''开户授权人证件类型'''
        return chr(ord(self.OpenManIdentifiedCardType))
    ...
    def getSettlementManIdentifiedCardType(self):
        '''结算单确认人证件类型'''
        return chr(ord(self.SettlementManIdentifiedCardType))
    ...
    def getInvestorType(self):
        '''投资者类型'''
        return chr(ord(self.InvestorType))
    ...
    def getCompanyManIdentifiedCardType(self):
        '''法人证件类型'''
        return chr(ord(self.CompanyManIdentifiedCardType))
    ...
    def getCorporationManIdentifiedCardType(self):
        '''法人代表证件类型'''
        return chr(ord(self.CorporationManIdentifiedCardType))
    ...
    def getLinkManIdentifiedCardType(self):
        '''联系人证件类型'''
        return chr(ord(self.LinkManIdentifiedCardType))
    ...
    def getLedgerIdentifiedCardType(self):
        '''分户管理资产负责人证件类型'''
        return chr(ord(self.LedgerIdentifiedCardType))
    ...
    def getTrusteeIdentifiedCardType(self):
        '''托管人证件类型'''
        return chr(ord(self.TrusteeIdentifiedCardType))
    ...
    def getTrusteeCorporationManIdentifiedCardType(self):
        '''托管机构法人代表证件类型'''
        return chr(ord(self.TrusteeCorporationManIdentifiedCardType))
    ...
    def getTrusteeOpenManIdentifiedCardType(self):
        '''托管机构开户授权人证件类型'''
        return chr(ord(self.TrusteeOpenManIdentifiedCardType))
    ...
    def getTrusteeContactManIdentifiedCardType(self):
        '''托管机构联系人证件类型'''
        return chr(ord(self.TrusteeContactManIdentifiedCardType))
...
class  CShfeFtdcRiskNotifyPatternField(Structure):
    ...
    def getNotifyClass(self):
        '''通知类型'''
        return chr(ord(self.NotifyClass))
...
class  CShfeFtdcForceCloseStandardField(Structure):
    ...
    def getForceCloseLevel(self):
        '''强平标准'''
        return chr(ord(self.ForceCloseLevel))

    def getForceCloseRelease(self):
        '''强平资金释放标准'''
        return chr(ord(self.ForceCloseRelease))

    def getFCNonLimitFirst(self):
        '''非停板方向持仓优先'''
        self.FCNonLimitFirst

    def getFCPosiProfitLossFirst(self):
        '''亏损大的持仓优先'''
        self.FCPosiProfitLossFirst
...
class  CShfeFtdcForceClosePositionRuleField(Structure):
    ...
    def getFCPosiDirection(self):
        '''强平持仓方向'''
        return chr(ord(self.FCPosiDirection))

    def getFCHedgeFlag(self):
        '''强平投机套保标志'''
        return chr(ord(self.FCHedgeFlag))

    def getFCCombPosiFlag(self):
        '''强平组合持仓标志'''
        return chr(ord(self.FCCombPosiFlag))

    def getFCHistoryPosiOrder(self):
        '''强平历史持仓顺序'''
        return chr(ord(self.FCHistoryPosiOrder))

    def getFCPrice(self):
        '''强平价格类型'''
        return chr(ord(self.FCPrice))
...
class  CShfeFtdcForceClosePositionField(Structure):
    ...
    def getFCPriceType(self):
        '''强平价格类型'''
        return chr(ord(self.FCPriceType))
...
class  CShfeFtdcQrySafePriceRangeField(Structure):
    ...
    def getPriceVaryAlgo(self):
        '''合约价格波动方法'''
        return chr(ord(self.PriceVaryAlgo))

    def getRiskLevel(self):
        '''风险类型'''
        return chr(ord(self.RiskLevel))
...
class  CShfeFtdcPriceVaryParamField(Structure):
    ...
    def getBasePriceType(self):
        '''价格波动的基准价类型'''
        return chr(ord(self.BasePriceType))
...
class  CShfeFtdcTradeParamField(Structure):
    ...
    def getTradeParamID(self):
        '''参数代码'''
        return chr(ord(self.TradeParamID))
...
class  CShfeFtdcRiskParkedOrderField(Structure):
    ...
    def getTriggerType(self):
        '''触发类型'''
        return chr(ord(self.TriggerType))
...
class  CShfeFtdcRiskNotifyAField(Structure):
    ...
    def getNotifyMethod(self):
        '''风险通知途径'''
        return chr(ord(self.NotifyMethod))

    def getNotifyStatus(self):
        '''风险通知状态'''
        return chr(ord(self.NotifyStatus))
...
class  CShfeFtdcLinkStatusField(Structure):
    ...
    def getLinkStatus(self):
        '''连接状态'''
        return chr(ord(self.LinkStatus))
...
class  CShfeFtdcSeqIPGroupMarginField(Structure):
    ...
    def getLongOffsetAmount(self):
        '''多头折抵总金额'''
        self.LongOffsetAmount

    def getShortOffsetAmount(self):
        '''空头折抵总金额'''
        self.ShortOffsetAmount

    def getExchOffsetAmount(self):
        '''交易所折抵总金额'''
        self.ExchOffsetAmount

    def getLongExchOffsetAmount(self):
        '''交易所多头折抵总金额'''
        self.LongExchOffsetAmount
...
class  CShfeFtdcSTDCECombMarginParamField(Structure):
    ...
    def getSTDCECombType(self):
        '''风控大商所组合类型'''
        return chr(ord(self.STDCECombType))
...
class  CShfeFtdcRiskExecOrderField(Structure):
    ...
    def getActionType(self):
        '''执行类型'''
        return chr(ord(self.ActionType))
    ...
    def getReservePositionFlag(self):
        ...
        return chr(ord(self.ReservePositionFlag))

    def getCloseFlag(self):
        '''期权行权后生成的头寸是否自动平仓'''
        return chr(ord(self.CloseFlag))
    ...
    def getExecResult(self):
        '''执行结果'''
        return chr(ord(self.ExecResult))
...
class  CShfeFtdcETStrikePositionField(Structure):
    ...
    def getEXEPriceType(self):
        '''行权价格类型'''
        return chr(ord(self.EXEPriceType))
