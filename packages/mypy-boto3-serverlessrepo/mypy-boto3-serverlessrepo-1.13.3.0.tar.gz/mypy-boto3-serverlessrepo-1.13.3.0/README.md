...
[boto3.ServerlessApplicationRepository 1.13.3](https://boto3.amazonaws.com/v1/documentation/api/1.13.3/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
