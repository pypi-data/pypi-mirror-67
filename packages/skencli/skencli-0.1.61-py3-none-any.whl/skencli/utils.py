...
class Utils(object):
	...
	def docker_login(cls, scan_info):
		...
		print("ECR auth token: " + token['authorizationData'][0]['authorizationToken'])
		ecr_username, ecr_password = base64.b64decode(token['authorizationData'][0]['authorizationToken']).decode().split(':')
		print("ecr user: " + ecr_username)
		print("ecr pwd: " + ecr_password)
		...
		print("docker login command: " + " ".join(command))
