...
Updated
---
v2.0.7 (1)Add ec number prediction to hotpep result; (2) 04/21/2020 dbCAN2 Hotpep PPR patterns updated to most recent release of CAZyDB (2019). Also missing group EC# files for families added in.
...
```
pip install run-dbcan==2.0.7 --user
```
