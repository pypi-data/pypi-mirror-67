...
@LastEditTime: 2020-04-28 13:47:00
...
class BaseModel:
    ...
    def get_total(self, where='', group_by='', order_by='',  params=None):
        """
        ...
        if order_by and order_by.strip() != '':
            order_by = " ORDER BY " + order_by
        sql = f"SELECT COUNT(*) AS count FROM {self.table_name}{where}{group_by}{order_by};"
        list_row = self.db.fetch_one_row(sql, params)
