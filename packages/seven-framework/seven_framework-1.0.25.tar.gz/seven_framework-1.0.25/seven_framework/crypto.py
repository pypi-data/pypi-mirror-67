...
@LastEditTime: 2020-05-06 15:01:21
...
class CryptoHelper:
    ...
    def sha1_encrypt(self, source):
        ...
        if isinstance(source, str):
            sha1_sign.update(source.encode('utf-8'))
    ...
    @classmethod
    def aes_encrypt(self, source, password):
        """
        ...
        resource = aes.encrypt(self._aes_pad(source).encode("utf8"))
        result = str(base64.b64encode(resource), encoding="utf8")
        return result

    @classmethod
    def aes_decrypt(self, source, password):
        """
        ...
        resource = base64.decodebytes(source.encode("utf8"))
        result = aes.decrypt(resource).decode("utf8")
        return unpad(result)
