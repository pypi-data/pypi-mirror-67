# -*- coding: utf-8 -*-
#
# yalchemy documentation build configuration file, created by
...
version = str(yalchemy.__version__)
...
latex_documents = [(
    master_doc,
    'cookiecutterrepo_name.tex', 'yalchemy Documentation',
...
man_pages = [
    (master_doc, 'cookiecutterrepo_name', 'yalchemy Documentation',
     [author], 1)
]
