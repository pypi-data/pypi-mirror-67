...
class View(Frame):
    ...
    def create_widgets(self):
        ...
        self.l0 = Label(self, text="Emplacement:")
        self.l0.grid(row=0, sticky=W)
        self.corpora_path = StringVar('')
        self.l1 = Label(self, textvariable=self.corpora_path)
        ...
        checkbox = Checkbutton(self,
                               ...
                               command=self.do_nothing).grid(row=0, column=1, sticky=W)


        self.collapsebox_value = BooleanVar()
        collapsebox = Checkbutton(self,
                                  text="Ouvrir/Fermer tout",
                                  variable=self.collapsebox_value,
                                  command=lambda:
                                       self.collapse_nodes(
                                           self.collapsebox_value.get())).grid(row=1, column=1, sticky=W)
        ...
        self.tv.grid(row=4, column=0, columnspan=3, sticky=NSEW, pady=5)
        self.yscroll.configure(orient='vertical',command=self.tv.yview)
        self.yscroll.grid(row=4, column=3, sticky=N+S+W, pady=5 )
        ...
        self.buttonChoose = Button(self,
                                   text='Choisir',
                                   command=self.choose_folder, width=7).grid(row=0, column=2)
        self.buttonRefresh = Button(self,
                                    text='Rafraîchir',
        ...
        self.keyword_explained = StringVar()
        self.l2 = Label(self, textvariable=self.keyword).grid(row=5, sticky=W)
        self.l3 = Label(self, textvariable=self.keyword_explained).grid(row=5, column=1,sticky=W+S)
        self.buttonSetKeywordExplanation = Button (self,
                                                   text = "Editer",
                                                   command= self.set_key_explanation, width=7)
        self.buttonSetKeywordExplanation.grid(row=5, column=2, sticky=S)
