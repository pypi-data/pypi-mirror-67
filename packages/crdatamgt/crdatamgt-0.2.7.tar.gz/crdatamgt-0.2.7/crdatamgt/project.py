...
def project_load_from_workbooks(workbooks, **kwargs):
    ...
    project_name = re.search(r'(Project .*)',kwargs.get('RESULTS DIRECTORY'))
    excel_name = f'{project_name}_{datetime.datetime}'
    workbook_save(excel_name, output_path, compiled, 'Results', **formatting)
