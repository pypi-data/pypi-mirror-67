...
class Coils:
    ...
    idealTrimCoilsIds = [350, 241, 351, 352, 353]  # trim coils in modules 1, 2, 3, 4, 5
    ...
    asbuiltCoilsIds = deformedNonPlanarCoilsIds + deformedPlanarCoilsIds + idealSweepCoilsIds + idealTrimCoilsIds  # No Sweep and Trim coils provided here!
