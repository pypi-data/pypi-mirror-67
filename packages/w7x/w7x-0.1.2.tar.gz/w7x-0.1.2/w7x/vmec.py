...
class Run(object):
    ...
    def _parse_input(self, **kwargs):
        ...
        input_path = tfields.lib.in_out.resolve(
    ...
    def _gen_folder(self):
        ...
        folder = tfields.lib.in_out.resolve(self._folder + self.vmec_id)
    ...
    def _parse_wout(self, **kwargs):
        ...
        wout_path = tfields.lib.in_out.resolve(
            self._folder + self.vmec_id +
    ...
    def _parse_threed1(self, **kwargs):
        ...
        filePath = tfields.lib.in_out.resolve(
            self._folder + "{self.vmec_id}.threed1.json".format(**locals()))
        threed1_path = tfields.lib.in_out.resolve(
            self._folder + self.vmec_id +
