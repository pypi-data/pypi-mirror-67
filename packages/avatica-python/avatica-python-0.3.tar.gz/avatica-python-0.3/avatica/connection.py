...
import uuid
import weakref
from avatica import errors
from avatica.client import OPEN_CONNECTION_PROPERTIES
from avatica.cursor import Cursor
from avatica.errors import ProgrammingError
