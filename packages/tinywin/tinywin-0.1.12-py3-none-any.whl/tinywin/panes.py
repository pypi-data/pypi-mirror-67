...
class Scroll_Pane(core.Pane):
    ...
    This Pane allows contents to automaticall be scrolled based on the type
    of scroll pane in use (as defined by Scroll_Pane_Type). The following
    types are supported:
    ...
    User functions:
        attach_selection_changed_callback
        attach_cursor_moved_callback
        set_header_line
        set_footer_line
        set_contents
        get_contents
