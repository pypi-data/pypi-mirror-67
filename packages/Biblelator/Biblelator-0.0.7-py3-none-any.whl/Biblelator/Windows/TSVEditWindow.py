...
class TSVEditWindowAddon:
    ...
    def buildWidgets( self ):
        ...
        self.rowSpinbox = tk.Spinbox( idFrame, from_=1.0, to=max(2, self.numDataRows),
                                textvariable=self.rowNumberVar, width=3, command=self._spinToNewRow )
        ...
        for j, (fieldData,(var,widget)) in enumerate( zip( currentRowData, self.widgets ) ):
            ...
            if j == self.bookColumn: # Label
                ...
                if fieldData:
                    ...
                    for j,(iB,controllingWindowList) in enumerate( self.parentApp.internalBibles ):
                ...
                if fieldData:
                    ...
                    for j,(iB,controllingWindowList) in enumerate( self.parentApp.internalBibles ):
                        if iB.abbreviation == 'ULT':
                            ...
                            # TODO: Handle ellipsis
                            if fieldData not in ULTtext:
                                errorList.append( f"Can't find GLQuote in ULT: '{fieldData}'" ); haveError = True
                            break
