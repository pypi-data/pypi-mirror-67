...
class TSVEditWindowAddon:
    ...
    def buildWidgets( self ):
        """
        """
        vPrint( 'Normal', debuggingThisModule, "TSVEditWindowAddon.buildWidgets()…" )
    ...
    def gotoRow( self, event=None, force:bool=False, notifyMain:bool=True ) -> None:
        ...
        """
        vPrint( 'Verbose', debuggingThisModule, f"gotoRow( {event}, f={force}, nM={notifyMain} ) from {self.current_row}…" )
    ...
    def validateTSVTable( self ) -> int:
        ...
        """
        vPrint( 'Info', debuggingThisModule, "validateTSVTable()…" )
        num_errors = 0
        self.allIDs = set()
