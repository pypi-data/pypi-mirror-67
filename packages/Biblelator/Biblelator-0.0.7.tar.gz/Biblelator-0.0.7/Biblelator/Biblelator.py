...
LAST_MODIFIED_DATE = '2020-04-28' # by RJH -- note that this isn't necessarily the displayed date at start-up
...
class Application( Frame ):
    ...
    def doOpenBiblelatorProject( self ) -> None:
        """
        """
        vPrint( 'Never', debuggingThisModule, "doOpenBiblelatorProject()" )
    ...
    def openBiblelatorBibleEditWindow( self, projectFolderpath, editMode=None, windowGeometry=None ):
        ...
        """
        vPrint( 'Never', debuggingThisModule, "openBiblelatorBibleEditWindow( {!r} )".format( projectFolderpath ) )
        if BibleOrgSysGlobals.debugFlag:
    ...
    def doOpenParatext8Project( self ) -> None:
        ...
        """
        vPrint( 'Never', debuggingThisModule, "doOpenParatext8Project()" )
    ...
    def openParatext8BibleEditWindow( self, settingsFolder, editMode=None, windowGeometry=None ):
        ...
        Returns the new USFMEditWindow object.
        """
        vPrint( 'Never', debuggingThisModule, "openParatext8BibleEditWindow( {!r} )".format( settingsFolder ) )
    ...
    def doOpenParatext7Project( self ) -> None:
        ...
        """
        vPrint( 'Never', debuggingThisModule, "doOpenParatext7Project()" )
    ...
    def openParatext7BibleEditWindow( self, SSFFilepath, editMode=None, windowGeometry=None ):
        ...
        Returns the new USFMEditWindow object.
        """
        vPrint( 'Never', debuggingThisModule, "openParatext7BibleEditWindow( {!r} )".format( SSFFilepath ) )
        if BibleOrgSysGlobals.debugFlag:
    ...
    def doOpenTSVProject( self ) -> None:
        ...
        Then open the file in a TSV edit window.
        """
        vPrint( 'Never', debuggingThisModule, "doOpenTSVProject()" )
