...
if __name__ == '__main__':
    # param_bond, woe_all, theta = get_param_bond_woe_all_theta(str_data)
    #
    # print (param_bond)
    # print (woe_all)
    # print (theta)
    print ()
    # print (get_GBK_Name('C:/Users/donglei/Desktop/EsModel/EsNewModel/Csvs/Csv1227/CsvFile/com_param_corr_sheet7.csv'))