...
from lapras.ModelCode import AnalyzeData
...
from lapras.ModelCode.loadData import get_only_model_data


def run_model(datafilepath,run_type_cus=-1):
    # 建模
    if run_type_cus == 0:
        AnalyzeData.state_data(datafilepath, ruleFilePriName, 0)
    elif run_type_cus == 1:
        get_only_model_data()
