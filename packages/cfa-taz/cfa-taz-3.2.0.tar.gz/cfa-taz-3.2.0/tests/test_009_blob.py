...
class BlobTests(unittest.TestCase):
    ...
    def test_075_blob_download(self):
        self.test_040_get_blob()
        print(self.blob.name)
        print(self.localpath)
        self.blob.download(self.localpath)

    def test_076_blob_get_properties(self):
        self.test_040_get_blob()
        print(type(self.blob.get_properties()))
    ...
    # WARNING: do not delete conatiner for aci logs save test to pass
    #
