...
setup(name='isort_black_compat',
      version='4.3.22',
      description='A Python utility / library to sort Python imports written by Timothy Crosley',
      long_description=readme,
      author='Sam Shleifer',
      author_email='sshleifer@gmail.com',
      url='https://github.com/sshleifer/isort',
      license="MIT",
      entry_points={
        'console_scripts': [
