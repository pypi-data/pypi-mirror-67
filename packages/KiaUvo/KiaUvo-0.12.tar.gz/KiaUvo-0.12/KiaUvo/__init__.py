...
class KiaUvo(object):
    ...
    def get_vehicle_status_by_id(self, vehicle_id):
        ...
        return Vehicle(result['vehicle'], result['status'], self._get_vehicle_maintenance(vehicle_id))
    ...
    def get_vehicle_status(self):
        ...
        headers.update({
            ...
            'referer': 'https://www.myuvo.ca/remote'
        })
        ...
        return Vehicle(
            result['vehicle'],
            result['status'],
            self._get_vehicle_maintenance(self.vehicle_id),
            self._fetch_engine_start_presets(self.vehicle_id))
