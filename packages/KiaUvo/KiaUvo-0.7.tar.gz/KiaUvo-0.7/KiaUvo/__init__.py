...
from KiaUvo.exceptions import NoVehicleException, InvalidAuthException
...
class KiaUvo(object):
    ...
    def get_vehicle_status(self):
        ...
        return Vehicle(result['vehicle'], result['status'], self.get_vehicle_maintenance())

    def get_vehicle_maintenance(self):
        if self.auth is None:
            raise InvalidAuthException
    ...
    def fetch_engine_start_presets(self):
        if self.auth is None:
            raise InvalidAuthException
