...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'mongodbatlas', 'v0.0.1-alpha.1588028806+g42031ca'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource mongodbatlas v0.0.1-alpha.1588028806+g42031ca`
                """)
            else:
                raise
