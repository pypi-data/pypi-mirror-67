            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i499 in range(_size495):
                        _elem500 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i513 in range(_size509):
                        _elem514 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i576 in range(_size572):
                        _elem577 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i590 in range(_size586):
                        _elem591 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i597 in range(_size593):
                        _elem598 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i667 in range(_size663):
                        _key668 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val669 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i716 in range(_size712):
                        _elem717 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                ...
                if ftype == TType.LIST:
                    ...
                    for _i722 in range(_size718):
                        _elem723 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.partitionVals is not None:
            ...
            for iter755 in self.partitionVals:
                oprot.writeString(iter755.encode('utf-8') if sys.version_info[0] == 2 else iter755)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i840 in range(_size836):
                        _elem841 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.tblNames is not None:
            ...
            for iter842 in self.tblNames:
                oprot.writeString(iter842.encode('utf-8') if sys.version_info[0] == 2 else iter842)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.capabilities is not None:
            oprot.writeFieldBegin('capabilities', TType.STRUCT, 3)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i855 in range(_size851):
                        _elem856 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i868 in range(_size864):
                        _elem869 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i989 in range(_size985):
                        _elem990 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
...
Table.thrift_spec = (
    ...
    (24, TType.LIST, 'requiredReadCapabilities', (TType.STRING, 'UTF8', False), None, ),  # 24
    (25, TType.LIST, 'requiredWriteCapabilities', (TType.STRING, 'UTF8', False), None, ),  # 25
