...
class Test(SerialLink):
    ...
    def __init__(self):
        ...
        L0 = Prismatic(a =    0.0, d =  0.0, alpha =      0.0, qlim = np.array([-2.8973, 2.8973]), mdh = 1)
        ...
        super(Test, self).__init__(L, name = 'Panda', manufacturer = 'Franka Emika', tool = xyzrpy_to_trans(0, 0, d7, 0, 0, -np.pi/4))
