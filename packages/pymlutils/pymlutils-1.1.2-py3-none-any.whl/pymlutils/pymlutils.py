...
def convert_image_ext(image_location, image_format, should_remove=False, should_print=True):
  """ Convert image format of provided images,
  Args:
    image_location: Full path to directory or a file with a list of full paths to other files.
    should_remove: Whether to delete the old image.
...
def rm_files(list_, should_print=True):
  ...
  Args:
    List of full paths to files in question.
  return:
    True when finished
  """
  for path in list_:
...
def to_png(list_, should_remove=False, should_print=True):
  """ Convert a jpg image to a png image, optionally deleting old file.
  Args:
    list_: List of full paths to files in question.
...
def to_jpg(list_, should_remove=False, should_print=True):
  """ Convert a png image to a jpg image, optionally deleting old file.
  Args:
    list_: List of full paths to files in question.
    should_remove: Whether to delete the old png image.
    should_print: Whether to print feedback.
  return:
    List of paths of converted images.
  """
