...
def parse_json_file(json_file_parse, paramsFile, phone_cookie_yaml):
    ...
    for i in range(0, len(names)):
        ...
        if request_raw != []:
            ...
            print(date_json)
            request_result_list, param_get_list, request_result_url = assemble_params_raw(
                request_method, request_url, request_query, date_json, paramsFile, phone_cookie_yaml)
        else:
