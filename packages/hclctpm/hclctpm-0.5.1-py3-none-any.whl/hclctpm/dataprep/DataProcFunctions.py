...
def CLDataPreparation(dataspecs): 
    ...
    ### Input:
    ###   dataspecs: dict() of data related parameters specified in the model development notebook
    
    ### Output: 
    ###   Dtrain: training data as dict(), each key is data segement for causal learning input
    ###   Dtrain['D'] = D  # full numpy array of the data shape = (num_samples, num_features) 
    
    ###   Dval:   validation data as dict(), each key is data segement for causal learning input 
    ###   Dtest:  test data as dict(), each key is data segement for causal learning input
    ...
    Dtrain = dict() 
    Dtrain['D'] = D ## full numpy array of the data as model input, shape = (num_samples, num_features) 
    Dtrain['o'] = o ## numpy array of gain/order per sample, shape = (num_samples, ) 
    Dtrain['c'] = c ## numpy array of cost per sample, shape = (num_samples, ) 
    Dtrain['w'] = w ## numpy array of treatment label (binary) on the sample, shape = (num_samples, ) 
