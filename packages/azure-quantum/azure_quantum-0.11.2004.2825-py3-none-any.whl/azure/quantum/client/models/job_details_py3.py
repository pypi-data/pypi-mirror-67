...
class JobDetails(Model):
    ...
    :vartype status: str or ~azure.quantum.client.models.Status
    ...
    :vartype error_data: ~azure.quantum.client.models.RestError
    """
    ...
    def __init__(self, *, container_uri: str, input_data_format: str, provider_id: str, target: str, id: str=None, input_data_uri: str=None, input_params=None, metadata=None, output_data_format=None, **kwargs) -> None:
