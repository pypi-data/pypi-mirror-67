...
class Solver:
    ...
    def submit(self, problem: Union[str, Problem]) -> Job:
        ...
        problem_uri = problem if isinstance(problem, str) else problem.upload(self.workspace, compress=True, container_name=container_name, blob_name="inputData")
        logger.info(f"Using problem payload from: {problem_uri}")
