...
class InvalidDefaultValueInConfigClassError(ConfigBaseError):
    """Raised if the default value of a field of the config class was not recognized."""

    def __init__(self, field_name: str):
        super().__init__(f"The field '{field_name}' of the config class is invalid")
