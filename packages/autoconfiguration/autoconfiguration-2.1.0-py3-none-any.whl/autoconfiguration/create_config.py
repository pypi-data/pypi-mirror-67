...
from autoconfiguration.exceptions.config_class_errors import (
    InvalidDefaultValueInConfigClassError,
)
...
def _get_value_of_field(field: dataclasses.Field, sections: Dict):
    ...
    is Optional and has no default value. The default value is returned if the field
    is not Optional. Otherwise MISSING_VALUE is returned.

    :param field: The field of the config class
    :param sections: The sections of the config files containing the values for the
        instance of the config class
    :return: Section value, None, default value or MISSING_VALUE depending on the
...
def _get_default(field: dataclasses.Field) -> Any:
    """
    Returns the default value of the passed field. An exception is raised if the field
    has no default value.

    :param field: The field with a default value
    ...
    raise InvalidDefaultValueInConfigClassError(field.name)
