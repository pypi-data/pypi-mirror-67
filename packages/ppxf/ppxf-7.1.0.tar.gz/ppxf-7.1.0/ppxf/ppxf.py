...
class ppxf:
    ...
    linear:
        ...
        are zero.
    linear_method: {'nnls', 'lsqlin'} optional
        Method used for the solution of the linear least-squares subproblem
        to fit for the templates weights (default 'nnls').

        The computational speed of the two linear methods depends on the size
        of the problem, with 'lsqlin' generally being faster with smaller
        problem and 'nnls' being faster for larger ones. Testing is recomended
    ...
    def __init__(self, templates, galaxy, noise, velscale, start,
        ...
        assert linear_method in ['nnls', 'lsqlin'], "`linear_method` must be 'nnls' or 'lsqlin'"
...
################################################################################
    ...
    def set_linear_constraints(self, constr_templ, constr_kinem, method):
        ...
        if self.fraction is not None:
            assert self.linear_method == 'lsqlin', "`fraction` requires `linear_method` == 'lsqlin'"
        ...
        if self.gas_any_zero:
            assert self.linear_method == 'lsqlin', "identically-zero gas templates require `linear_method` == 'lsqlin'"
        ...
        if constr_templ != {}:
            assert self.linear_method == 'lsqlin', "`constr_templ` require `linear_method` == 'lsqlin'"
