...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', 'v2.1.0-alpha.1588030364+g6d31bc4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven v2.1.0-alpha.1588030364+g6d31bc4`
                """)
            else:
                raise
