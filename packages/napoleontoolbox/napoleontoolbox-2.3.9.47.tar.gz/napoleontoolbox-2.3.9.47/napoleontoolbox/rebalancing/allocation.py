...
def rolling_ensembling(X, w_mat_predictors_list, w_mat_target, n=252, s=63,ret=True, ensembling_model = 'other', period = 252, **kwargs):
    ...
    if ensembling_model == 'min_sharpe':
        ...
        w_mat = w_mat.fillna(method='ffill').fillna(0.)
        return portfolio, w_mat
    elif ensembling_model == 'period_min_dd':
        ...
        index_tmp = w_mat_predictors_list[0].index
        print('length after filtering '+ str(len(index_tmp)))
        ...
        print('optimizing')
        optimal_weights = metrics.find_best_perf_weights(X_filtered, filtered_w_mat_predictors_list)
