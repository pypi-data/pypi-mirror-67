...
def select_orthogonal_coef(wtmra, coeff_index_factor, independent_selection):
    ...
    for j in range(len(components)):
        ...
        if independent_selection:
            ...
            non_independent_indexes = sum(independent_ortho_index)
            non_independent_indexes[non_independent_indexes != 0] = 1
            non_independent_ortho_coeff = sum(wtmra)*non_independent_indexes
            return non_independent_ortho_coeff
