...
class AbstractRunner(ABC):
    def __init__(self, starting_date = None, running_date = None, drop_token=None, dropbox_backup = True, underlying = None, freqly_pkl_file_name_sufffix='freqly_candels.pkl', local_root_directory='../data/', user = 'napoleon',nb_items_per_year=252):
        super().__init__()
