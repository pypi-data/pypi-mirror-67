...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of truelayer.auth.signing.HttpSigningConfiguration
    ...
    You can programmatically set the cookie:
      conf = truelayer.auth.Configuration(
    ...
    Note you can use the constants defined in the truelayer.auth.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = truelayer.auth.Configuration(
        signing_info = truelayer.auth.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
    ...
    def __init__(self, host="https://auth.truelayer-sandbox.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("truelayer.auth")
