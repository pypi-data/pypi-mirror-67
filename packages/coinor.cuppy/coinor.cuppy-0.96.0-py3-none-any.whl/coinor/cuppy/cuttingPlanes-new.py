...
def gomoryCut(lp, integerIndices = None, sense = '>=', sol = None,
              rowInds = None, value = None, epsilon = 10**(-eps),
              debug_print = True):
    ...
    for row in rowInds:
        ...
        if (basicVarInd in integerIndices) and (not isInt(sol[basicVarInd])):
            ...
            # if debug_print:
            #     print (pi, pi0)
            # if np.around(pi0, decimals = eps) != 0:
            #     pi *= 1/pi0
            #     if debug_print:
            #         print(pi)
            ...
            #     if debug_print:
            #         print(pi)
            #     if (sense == '>=' and pi0 >= 0) or (sense == '<=' and pi0 <= 0):
            #         cuts.append((pi, 1))
            #     else:
            #         cuts.append((-pi, -1))
            # else:
            #     print("Right-hand side too small, discarding cut")
