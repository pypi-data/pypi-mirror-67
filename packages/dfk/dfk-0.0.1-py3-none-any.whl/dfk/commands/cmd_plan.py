...
def get(id):
    ...
    try:
        get_plan_result = api_instance.plan_get(plan_id=id)
...
def list():
    ...
    try:
        list_plans_result = api_instance.plan_list()
...
def start(file):
    ...
    try:
        ...
        start_plan_result = api_instance.plan_add(plan=plan_obj)
...
def stop(id):
    ...
    try:
        stop_plan_result = api_instance.plan_delete(plan_id=id)
...
def validate(file_path):
    ...
    try:
        ...
        validate_plan_result = api_instance.plan_validate(plan=plan_obj)
...
def template():
    ...
    raise NotImplementedError("You must implement the validate() method yourself!")
