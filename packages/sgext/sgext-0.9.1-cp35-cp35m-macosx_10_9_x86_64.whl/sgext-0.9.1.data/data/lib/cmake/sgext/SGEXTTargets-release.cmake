...
set_target_properties(SGEXT::SGCore PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGCore.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGCore )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGCore "${_IMPORT_PREFIX}/lib/libSGCore.a" )
...
set_target_properties(SGEXT::SGExtract PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGExtract.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGExtract )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGExtract "${_IMPORT_PREFIX}/lib/libSGExtract.a" )
...
set_target_properties(SGEXT::SGAnalyze PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGAnalyze.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGAnalyze )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGAnalyze "${_IMPORT_PREFIX}/lib/libSGAnalyze.a" )
...
set_target_properties(SGEXT::SGLocate PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGLocate.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGLocate )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGLocate "${_IMPORT_PREFIX}/lib/libSGLocate.a" )
...
set_target_properties(SGEXT::SGCompare PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGCompare.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGCompare )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGCompare "${_IMPORT_PREFIX}/lib/libSGCompare.a" )
...
set_target_properties(SGEXT::SGGenerate PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGGenerate.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGGenerate )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGGenerate "${_IMPORT_PREFIX}/lib/libSGGenerate.a" )
...
set_target_properties(SGEXT::SGDynamics PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSGDynamics.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS SGEXT::SGDynamics )
list(APPEND _IMPORT_CHECK_FILES_FOR_SGEXT::SGDynamics "${_IMPORT_PREFIX}/lib/libSGDynamics.a" )
