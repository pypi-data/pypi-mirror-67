...
class MetricOperations(object):
    ...
    def get_full_fidelity(
            self, subscription_id, resource_group_name, workspace_name, experiment_name, run_id, request_dto, custom_headers=None, raw=False, **operation_config):
        """
        ...
        return deserialized
    get_full_fidelity.metadata = {'url': '/metric/v2.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/runid/{runId}/full'}
