...
class Issuer(object):
    ...
    def upstream_redirect_uri(self, upstream_redirect_uri):
        ...
        if (self.local_vars_configuration.client_side_validation and
                upstream_redirect_uri is not None and len(upstream_redirect_uri) < 1):
            raise ValueError("Invalid value for `upstream_redirect_uri`, length must be greater than or equal to `1`")  # noqa: E501
