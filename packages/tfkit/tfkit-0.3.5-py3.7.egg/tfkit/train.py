...
def train(models_list, train_dataset, models_tag, arg, fname, epoch, maxlen):
    optims = []
    models = []
...
def main():
    ...
    for epoch in range(start_epoch, start_epoch + arg.epoch):
        ...
        train_avg_loss = train(models, train_dataset, models_tag, arg, fname, epoch, train_ds_maxlen)
