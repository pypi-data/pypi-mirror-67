...
from ...utils.django import run_dumpdata_backup, move_dumpdata_backup
...
class Command(BaseCommand):
    help = 'Executes dumpdata JSON backup'
    ...
    def handle(self, *args, **options):
        ...
        try:
            dump_all_filepath = os.path.abspath(os.path.join(ROOT_DIR, DJANGO_PROJECT_BACKUP_DUMPDATA_JSON_FILENAME))
