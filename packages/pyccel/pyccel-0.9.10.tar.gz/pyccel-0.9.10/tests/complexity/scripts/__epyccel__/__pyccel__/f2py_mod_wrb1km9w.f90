subroutine product_loop_on_2d_array_C (n0_z, n1_z, z) 

  use mod_wrb1km9w, only: mod_product_loop_on_2d_array_C => &
      product_loop_on_2d_array_C
  implicit none
  ...
  !f2py intent(c) z
  call mod_product_loop_on_2d_array_C(z)
end subroutine