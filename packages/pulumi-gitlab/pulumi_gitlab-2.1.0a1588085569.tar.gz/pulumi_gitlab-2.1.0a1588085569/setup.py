...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gitlab', 'v2.1.0-alpha.1588085569+g89c053b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gitlab v2.1.0-alpha.1588085569+g89c053b`
                """)
            else:
                raise
