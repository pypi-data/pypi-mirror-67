...
from spell.cli.utils import is_installed, cluster_utils, echo_error
...
def eks_init(
    ...
    try:
        ...
        echo_error("Cluster Autoscaling failed to set up. Error was: {}".format(e))
    ...
    try:
        ...
        echo_error("metrics-server failed to set up. Error was: {}".format(e))
    ...
    try:
        ...
        echo_error("Setting up Ambassador failed. Error was: {}".format(e))
    ...
    try:
        ...
        echo_error("Uploading config to Spell failed. Error was: {}".format(e))
