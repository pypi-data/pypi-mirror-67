...
class ClusterClient(base_client.BaseClient):
    ...
    def register_serving_group(
        ...
        """Create an autoscaling node gropu within a model serving cluster
    ...
    def mark_serving_group_ready(
        self, cluster_name, serving_group_id,
    ):
        """Create an autoscaling node gropu within a model serving cluster

        Keyword arguments:
        cluster_name -- the name of the cluster
        serving_group_id -- the ID of the serving group
        """
