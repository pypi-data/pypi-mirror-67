...
class API:
    ...
    @classmethod
    def from_module(cls, module_path: Union[Path, str], classpath: Optional[str]):
        # module_path is the path in the filesystem to the module
        # classpath is the python path to the predictor in the form path.to.module:MyPredictor
        python_path, _, classname = classpath.partition(":")
