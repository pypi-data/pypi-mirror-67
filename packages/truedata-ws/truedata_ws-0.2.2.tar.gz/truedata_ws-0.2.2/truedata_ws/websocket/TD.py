...
class LiveClient(WebSocketApp):
    ...
    def handle_message_data(self, msg):
        ...
        if msg['message'] == 'TrueData Real Time Data Service':  # Connection success message
            print(f"You can trade on {msg['segments']}")  # TODO: Format statement better
...
class TD:
    ...
    def get_historic_data(self, contract,
        ...
        if duration is not None:
            ...
            return self.get_historic_data_from_start_time(contract=contract,
                                                          ticker_id=ticker_id,
                                                          query_time=query_time,
    ...
    def get_historic_data_from_start_time(self, contract,
                                          ticker_id=DEFAULT_HISTORIC_DATA_ID,
                                          query_time=None,
                                          start_time=None,
                                          bar_size="1 min"):
