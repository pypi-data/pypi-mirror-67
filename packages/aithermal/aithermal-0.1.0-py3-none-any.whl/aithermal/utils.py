...
def write_yaml():
    ...
    return {'BASELINE DIRECTORY': '', 'PROJECT DIRECTORY': tests, 'WAVE LENGTHS': [None, None, None, None],
            'GRADIENT': 30, 'RMS': False,
            "ISOTHERMS": [190, 220, 350], "Techniques": {"STA": True, "IR": True, "GC": False, "MS": True}}
