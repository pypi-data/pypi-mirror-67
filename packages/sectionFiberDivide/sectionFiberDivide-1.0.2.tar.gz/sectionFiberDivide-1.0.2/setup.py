...
ext_modules=[]
ext_modules+=[Extension('sectionFiberDivide.cythonPointInPolygon',['sectionFiberDivide/cythonPointInPolygon.c'],include_dirs=[numpy.get_include()])]
ext_modules+=[Extension('sectionFiberDivide.cythonSectionFiber',['sectionFiberDivide/cythonSectionFiber.c'],include_dirs=[numpy.get_include()])]
