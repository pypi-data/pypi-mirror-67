...
__jsii_assembly__ = jsii.JSIIAssembly.load("cdk-watchful", "0.5.0", __name__, "cdk-watchful@0.5.0.jsii.tgz")
...
class WatchfulProps():
    def __init__(self, *, alarm_email: typing.Optional[str]=None, alarm_sns: typing.Optional[aws_cdk.aws_sns.ITopic]=None, alarm_sqs: typing.Optional[aws_cdk.aws_sqs.IQueue]=None):
        """
        :param alarm_email: -
        :param alarm_sns: -
        :param alarm_sqs: -
